	...
	if (document.$ === 'Node') {
		...
		return A2(author$project$Document$hasClass, 'sameHeightImgsRow', document) ? _Utils_Tuple2(
			A2(
				...
				newChildren),
			A2(elm$core$List$cons, id.uid, newUids)) : _Utils_Tuple2(
...
var author$project$Editor$CurrentViewportOf = F2(
	function (a, b) {
		return {$: 'CurrentViewportOf', a: a, b: b};
	});
		...
		switch (msg.$) {
			case 'WinResize':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								author$project$Editor$updateSizes(model.config)
							])));
			...
			case 'CurrentViewportOf':
				...
				if (res.$ === 'Ok') {
					...
					var newSizesDict = A3(
						...
						uid,
						{
							docHeight: elm$core$Basics$round(viewport.height),
							docWidth: elm$core$Basics$round(viewport.width)
						},
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								hasRefreshed: _Utils_eq(newSizesDict, currentConfig.sizesDict)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var s = res.a.a;
					...
					_Utils_update(
						model,
						{
							document: function (nd) {
								return A2(author$project$DocumentZipper$updateCurrent, nd, model.document);
							}(
								A2(
			...
			case 'SelectDoc':
				...
				var _n2 = A2(
					...
					A2(author$project$DocumentZipper$updateCurrent, model.currentNodeBackup, model.document));
				if (_n2.$ === 'Nothing') {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								currentNodeBackup: author$project$DocumentZipper$extractDoc(newDocument),
								document: A2(author$project$DocumentZipper$addSelectors, author$project$Editor$handlers, newDocument),
...
var mdgriffith$stylish_elephants$Element$Phone = {$: 'Phone'};
var mdgriffith$stylish_elephants$Element$Tablet = {$: 'Tablet'};
var mdgriffith$stylish_elephants$Element$BigDesktop = {$: 'BigDesktop'};
var mdgriffith$stylish_elephants$Element$Desktop = {$: 'Desktop'};
var mdgriffith$stylish_elephants$Element$Landscape = {$: 'Landscape'};
var mdgriffith$stylish_elephants$Element$Portrait = {$: 'Portrait'};
var mdgriffith$stylish_elephants$Element$classifyDevice = function (window) {
	return {
		_class: (window.width <= 600) ? mdgriffith$stylish_elephants$Element$Phone : (((window.width > 600) && (window.width <= 1200)) ? mdgriffith$stylish_elephants$Element$Tablet : (((window.width > 1200) && (window.width <= 1800)) ? mdgriffith$stylish_elephants$Element$Desktop : mdgriffith$stylish_elephants$Element$BigDesktop)),
		orientation: (_Utils_cmp(window.width, window.height) < 0) ? mdgriffith$stylish_elephants$Element$Portrait : mdgriffith$stylish_elephants$Element$Landscape
	};
};
	...
	function (config, document) {
		...
		if (document.$ === 'Node') {
			...
			switch (nodeLabel.$) {
				...
				case 'Row':
					if (A2(author$project$Document$hasClass, 'sameHeightImgsRow', document) && A2(author$project$Document$containsOnly, author$project$Document$isImage, document)) {
						var _n4 = A2(elm$core$Dict$get, id.uid, config.sizesDict);
						if (_n4.$ === 'Just') {
							var docWidth = _n4.a.docWidth;
							var docHeight = _n4.a.docHeight;
							return A2(author$project$DocumentResponsive$renderSameHeightImgRow, docWidth, document);
						} else {
							return A2(author$project$DocumentResponsive$renderSameHeightImgRow, config.width, document);
						}
					} else {
						return A2(
							author$project$Document$Node,
			...
			switch (leafContent.$) {
				...
				case 'Table':
					var meta = leafContent.a;
					return ((_Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Phone) || _Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Tablet)) && (_Utils_cmp(meta.nbrCols, meta.nbrRows) > 0)) ? author$project$Document$Leaf(
						{
							attrs: attrs,
							id: id,
							leafContent: author$project$Document$Table(
...
var author$project$DocumentView$packStyleSheet = F2(
	function (styleSheet, document) {
		var paragraphStyle = styleSheet.paragraphStyle;
		var columnStyle = styleSheet.columnStyle;
		var rowStyle = styleSheet.rowStyle;
		var textColumnStyle = styleSheet.textColumnStyle;
		var respBlocStyle = styleSheet.respBlocStyle;
		var customStyles = styleSheet.customStyles;
		var imageStyle = styleSheet.imageStyle;
		var linkStyle = styleSheet.linkStyle;
		var textStyle = styleSheet.textStyle;
		var headingStyles = styleSheet.headingStyles;
		var packAttr = F2(
...
var mdgriffith$stylish_elephants$Internal$Style$classes = {above: 'a', active: 'atv', alignBottom: 'ab', alignCenterX: 'cx', alignCenterY: 'cy', alignContainerBottom: 'acb', alignContainerCenterX: 'accx', alignContainerCenterY: 'accy', alignContainerRight: 'acr', alignLeft: 'al', alignRight: 'ar', alignTop: 'at', alignedHorizontally: 'ah', alignedVertically: 'av', any: 's', behind: 'bh', below: 'b', bold: 'w7', borderDashed: 'bd', borderDotted: 'bdt', borderNone: 'bn', borderSolid: 'bs', capturePointerEvents: 'cpe', clip: 'cp', clipX: 'cpx', clipY: 'cpy', column: 'c', container: 'ctr', contentBottom: 'cb', contentCenterX: 'ccx', contentCenterY: 'ccy', contentLeft: 'cl', contentRight: 'cr', contentTop: 'ct', cursorPointer: 'cptr', cursorText: 'ctxt', focus: 'fcs', grid: 'g', hasBehind: 'hbh', heightContent: 'hc', heightFill: 'hf', heightFillPortion: 'hfp', hover: 'hv', imageContainer: 'ic', inFront: 'fr', inputMultiline: 'iml', inputText: 'it', italic: 'i', noTextSelection: 'notxt', onLeft: 'ol', onRight: 'or', opaque: 'oq', overflowHidden: 'oh', page: 'pg', paragraph: 'p', passPointerEvents: 'ppe', root: 'ui', row: 'r', scrollbars: 'sb', scrollbarsX: 'sbx', scrollbarsY: 'sby', seButton: 'sbt', single: 'e', spaceEvenly: 'sev', strike: 'sk', text: 't', textCenter: 'tc', textExtraBold: 'w8', textExtraLight: 'w2', textHeavy: 'w9', textJustify: 'tj', textJustifyAll: 'tja', textLeft: 'tl', textLight: 'w3', textMedium: 'w5', textNormalWeight: 'w4', textRight: 'tr', textSemiBold: 'w6', textThin: 'w1', textUnitalicized: 'tun', transition: 'ts', transparent: 'clr', underline: 'u', widthContent: 'wc', widthExact: 'we', widthFill: 'wf', widthFillPortion: 'wfp', wrapped: 'wrp'};
...
var mdgriffith$stylish_elephants$Element$Border$solid = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$borderStyle, mdgriffith$stylish_elephants$Internal$Style$classes.borderSolid);
...
var mdgriffith$stylish_elephants$Element$Font$alignLeft = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontAlignment, mdgriffith$stylish_elephants$Internal$Style$classes.textLeft);
var mdgriffith$stylish_elephants$Element$Font$alignRight = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontAlignment, mdgriffith$stylish_elephants$Internal$Style$classes.textRight);
...
var mdgriffith$stylish_elephants$Element$Font$italic = mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.italic);
var mdgriffith$stylish_elephants$Element$Font$justify = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontAlignment, mdgriffith$stylish_elephants$Internal$Style$classes.textJustify);
	...
	function (config, attrs) {
		...
		var renderAttr = function (attr) {
			switch (attr.$) {
				...
				case 'AlignRight':
					return (_Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Phone) || _Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Tablet)) ? _List_fromArray(
...
var mdgriffith$stylish_elephants$Internal$Model$columnClass = mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.column);
var mdgriffith$stylish_elephants$Internal$Model$gridClass = mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.grid);
var mdgriffith$stylish_elephants$Internal$Model$pageClass = mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.page);
var mdgriffith$stylish_elephants$Internal$Model$paragraphClass = mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.paragraph);
var mdgriffith$stylish_elephants$Internal$Model$rowClass = mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.row);
var mdgriffith$stylish_elephants$Internal$Model$singleClass = mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.single);
	...
	[
		...
		_Utils_ap(
			...
			_Utils_ap(
				...
				mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.imageContainer))),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
				mdgriffith$stylish_elephants$Internal$Style$Descriptor,
				mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.wrapped),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.hasBehind),
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'z-index', '0'),
								A2(
...
var mdgriffith$stylish_elephants$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + (mdgriffith$stylish_elephants$Internal$Style$classes.any + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + (mdgriffith$stylish_elephants$Internal$Style$classes.any + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
					...
					switch (pseudo.$) {
						...
						case 'Focus':
							...
							return A2(
								...
								'\n',
								_List_fromArray(
									[selector + ('-fs:focus {' + (renderedProps + '\n}')), '.' + (mdgriffith$stylish_elephants$Internal$Style$classes.any + (':focus ~ ' + (selector + ('-fs:not(.focus)  {' + (renderedProps + '\n}'))))), '.' + (mdgriffith$stylish_elephants$Internal$Style$classes.any + (':focus ' + (selector + ('-fs  {' + (renderedProps + '\n}'))))), '.focusable-parent:focus ~ ' + ('.' + (mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + (selector + ('-fs {' + (renderedProps + '\n}'))))))]));
						default:
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 'SpacingStyle':
						...
						var single = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.single;
						var row = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.row;
						var wrappedRow = '.' + (mdgriffith$stylish_elephants$Internal$Style$classes.wrapped + row);
						var right = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.alignRight;
						var paragraph = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.paragraph;
						var page = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.page;
						var left = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.alignLeft;
						var column = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.column;
						var _class = '.' + cls;
						var any = '.' + mdgriffith$stylish_elephants$Internal$Style$classes.any;
						return elm$core$String$concat(
							_List_fromArray(
								[
									A3(
					...
					A2(
						...
						A3(
							...
							_Utils_Tuple2(
								...
								_List_fromArray(
									[
										mdgriffith$stylish_elephants$Internal$Model$renderFocusStyle(opts.focus)
									])),
							styles).b)),
				children)) : A2(
			elm$core$List$cons,
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$stylish_elephants$Internal$Style$classes.any + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.single))
									]))
							]));
			}
		}();
					...
					case 'Styled':
						...
						return _Utils_eq(context, mdgriffith$stylish_elephants$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.html, mdgriffith$stylish_elephants$Internal$Model$NoStyleSheet, context)),
								A2(
									elm$core$List$cons,
									_Utils_Tuple2('sp', mdgriffith$stylish_elephants$Internal$Model$space),
									htmls)),
...
var mdgriffith$stylish_elephants$Internal$Model$Behind = {$: 'Behind'};
	...
	switch (h.$) {
		...
		case 'Content':
			return _Utils_Tuple3(
				...
				mdgriffith$stylish_elephants$Internal$Style$classes.heightContent,
				_List_Nil);
		case 'Fill':
			var portion = h.a;
			return (portion === 1) ? _Utils_Tuple3(
				...
				mdgriffith$stylish_elephants$Internal$Style$classes.heightFill,
	...
	switch (w.$) {
		...
		case 'Content':
			return _Utils_Tuple3(
				...
				mdgriffith$stylish_elephants$Internal$Style$classes.widthContent,
				_List_Nil);
		case 'Fill':
			var portion = w.a;
			return (portion === 1) ? _Utils_Tuple3(
				...
				mdgriffith$stylish_elephants$Internal$Style$classes.widthFill,
				_List_Nil) : _Utils_Tuple3(
				A2(mdgriffith$stylish_elephants$Internal$Flag$add, mdgriffith$stylish_elephants$Internal$Flag$widthFill, mdgriffith$stylish_elephants$Internal$Flag$none),
			...
			if (!elementAttrs.b) {
				...
				switch (attribute.$) {
					...
					case 'Width':
						...
						if (A2(mdgriffith$stylish_elephants$Internal$Flag$present, mdgriffith$stylish_elephants$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 'Px':
									var px = width.a;
									var $temp$classes = (mdgriffith$stylish_elephants$Internal$Style$classes.widthExact + (' width-px-' + elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
									...
									continue gatherAttrRecursive;
								case 'Content':
									var $temp$classes = classes + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.widthContent),
										$temp$node = node,
										$temp$has = A2(
								...
								case 'Fill':
									var portion = width.a;
									if (portion === 1) {
										var $temp$classes = classes + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.widthFill),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$stylish_elephants$Internal$Flag$add,
										...
										var $temp$classes = classes + (' ' + (mdgriffith$stylish_elephants$Internal$Style$classes.widthFillPortion + (' width-fill-' + elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$stylish_elephants$Internal$Flag$add,
											mdgriffith$stylish_elephants$Internal$Flag$widthFill,
						...
						if (A2(mdgriffith$stylish_elephants$Internal$Flag$present, mdgriffith$stylish_elephants$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 'Px':
									...
									continue gatherAttrRecursive;
								case 'Content':
									var $temp$classes = mdgriffith$stylish_elephants$Internal$Style$classes.heightContent + (' ' + classes),
										$temp$node = node,
										$temp$has = A2(
										mdgriffith$stylish_elephants$Internal$Flag$add,
								...
								case 'Fill':
									...
									if (portion === 1) {
										var $temp$classes = mdgriffith$stylish_elephants$Internal$Style$classes.heightFill + (' ' + classes),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$stylish_elephants$Internal$Flag$add,
										...
										var $temp$classes = classes + (' ' + (mdgriffith$stylish_elephants$Internal$Style$classes.heightFillPortion + (' height-fill-' + elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$stylish_elephants$Internal$Flag$add,
											mdgriffith$stylish_elephants$Internal$Flag$heightFill,
					...
					case 'Nearby':
						...
						var newClasses = _Utils_eq(location, mdgriffith$stylish_elephants$Internal$Model$Behind) ? (mdgriffith$stylish_elephants$Internal$Style$classes.hasBehind + (' ' + classes)) : classes;
							...
							_List_fromArray(
								[
									...
									switch (elem.$) {
										...
										default:
											var styled = elem.a;
											return A2(styled.html, mdgriffith$stylish_elephants$Internal$Model$NoStyleSheet, mdgriffith$stylish_elephants$Internal$Model$asEl);
									}
								}()
								]));
...
var mdgriffith$stylish_elephants$Internal$Model$Untransformed = {$: 'Untransformed'};
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.contentCenterX + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.contentCenterY)),
								attrs))))),
			mdgriffith$stylish_elephants$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var mdgriffith$stylish_elephants$Element$scrollbarX = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$overflow, mdgriffith$stylish_elephants$Internal$Style$classes.scrollbarsX);
...
var mdgriffith$stylish_elephants$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.contentTop + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.contentLeft)),
				A2(
					elm$core$List$cons,
					mdgriffith$stylish_elephants$Element$height(mdgriffith$stylish_elephants$Element$shrink),
					A2(
...
var mdgriffith$stylish_elephants$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.contentLeft + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.contentCenterY)),
				A2(
					elm$core$List$cons,
					mdgriffith$stylish_elephants$Element$width(mdgriffith$stylish_elephants$Element$shrink),
					A2(
		...
		return A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						mdgriffith$stylish_elephants$Element$width(
						A2(mdgriffith$stylish_elephants$Element$maximum, config.width, mdgriffith$stylish_elephants$Element$fill))
					]),
				A2(author$project$DocumentView$renderAttrs, config, attrs)),
			A2(
				elm$core$List$map,
...
var mdgriffith$stylish_elephants$Element$clip = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$overflow, mdgriffith$stylish_elephants$Internal$Style$classes.clip);
...
var author$project$StyleSheets$defaulStyleSheet = {
	...
	headingStyles: elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2(
				1,
					...
					A2(
						...
						A2(
							...
							author$project$DocumentZipper$extractDoc(
								author$project$DocumentZipper$rewind(model.document))))))
			]),
		title: 'editor'
	};
};
...
var author$project$Editor$main = elm$browser$Browser$document(
	{
		init: author$project$Editor$init(author$project$SampleDocs$sampleDoc1),
		subscriptions: author$project$Editor$subscriptions,
...
_Platform_export({'Editor':{'init':author$project$Editor$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Editor.Msg","aliases":{"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Editor.Msg":{"args":[],"tags":{"CurrentViewport":["Browser.Dom.Viewport"],"CurrentViewportOf":["Basics.Int","Result.Result Browser.Dom.Error Browser.Dom.Viewport"],"WinResize":["Basics.Int","Basics.Int"],"RefreshSizes":[],"NoOp":[],"SelectDoc":["Basics.Int"],"HoverDoc":["Basics.Int"]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));