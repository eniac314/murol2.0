...
{
	if (region.s.a1 === region.cg.a1)
	{
		return 'on line ' + region.s.a1;
	}
	return 'on lines ' + region.s.a1 + ' through ' + region.cg.a1;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ej: 'hidden', a_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ej: 'mozHidden', a_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ej: 'msHidden', a_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ej: 'webkitHidden', a_: 'webkitvisibilitychange' }
		: { ej: 'hidden', a_: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		bF: {
			...
			ei: _Browser_doc.documentElement.clientHeight
		}
	};
}
...
function _Browser_getScene()
{
	...
	return {
		...
		ei: Math.max(body.scrollHeight, body.offsetHeight, elem.scrollHeight, elem.offsetHeight, elem.clientHeight)
	};
}
...
function _Browser_getViewportOf(id)
{
	return _Browser_withNode(id, function(node)
	{
		return {
			cZ: {
				fZ: node.scrollWidth,
				ei: node.scrollHeight
			},
			bF: {
				bG: node.scrollLeft,
				c9: node.scrollTop,
				fZ: node.clientWidth,
				ei: node.clientHeight
			}
		};
	});
}
...
var author$project$Document$hasClass = F2(
	function (_class, document) {
		if (!document.$) {
			var nv = document.a;
			return A2(elm$core$Set$member, _class, nv.c.Y);
		} else {
			var lv = document.a;
			return A2(elm$core$Set$member, _class, lv.c.Y);
		}
	});
				...
				_Utils_update(
					cv,
					{
						c: _Utils_update(
							id,
							{
								_: elm$core$Maybe$Just(sid)
							})
					}));
		} else {
			var cv = doc.a;
			var containerLabel = cv.au;
			var id = cv.c;
			var attrs = cv.v;
			var xs = doc.b;
			return A2(
	...
	if (!document.$) {
		...
		return A2(author$project$Document$hasClass, 'sameHeightImgsRow', document) ? _Utils_Tuple2(
			A2(
				...
				htmlId(id.aM),
				document),
			A2(elm$core$List$cons, id.aM, newUids)) : _Utils_Tuple2(
...
var mdgriffith$elm_ui$Internal$Style$classes = {db: 'a', bH: 'atv', dd: 'ab', de: 'cx', df: 'cy', dg: 'acb', dh: 'accx', di: 'accy', dj: 'acr', b6: 'al', b7: 'ar', dk: 'at', bI: 'ah', bJ: 'av', dn: 's', dq: 'bh', dr: 'b', du: 'w7', dw: 'bd', dx: 'bdt', bf: 'bn', dy: 'bs', bg: 'cpe', dI: 'cp', dJ: 'cpx', dK: 'cpy', aj: 'c', bj: 'ctr', bk: 'cb', bl: 'ccx', ak: 'ccy', a$: 'cl', bm: 'cr', dT: 'ct', dY: 'cptr', dZ: 'ctxt', ed: 'fcs', ee: 'g', ef: 'hbh', a0: 'hc', bS: 'hf', co: 'hfp', ek: 'hv', eo: 'ic', et: 'fr', ew: 'iml', ex: 'it', eA: 'i', eN: 'notxt', eR: 'ol', eU: 'or', aF: 'oq', eZ: 'oh', cI: 'pg', cK: 'p', e0: 'ppe', e7: 'ui', cX: 'r', fb: 'sb', fc: 'sbx', fd: 'sby', fe: 'sbt', fh: 'e', fk: 'sev', fq: 'sk', bD: 't', fz: 'tc', fB: 'w8', fC: 'w2', fD: 'w9', fE: 'tj', bE: 'tja', fF: 'tl', fG: 'w3', fH: 'w5', fI: 'w4', fJ: 'tr', fK: 'w6', fM: 'w1', fN: 'tun', c6: 'ts', aL: 'clr', fV: 'u', b2: 'wc', c7: 'we', b3: 'wf', c8: 'wfp', b4: 'wrp'};
	...
	return elm$core$String$concat(
		_List_fromArray(
			[
				...
				elm$core$String$fromFloat(shadow.eP.a) + 'px',
				elm$core$String$fromFloat(shadow.eP.b) + 'px',
				elm$core$String$fromFloat(shadow.ds) + 'px',
				elm$core$String$fromFloat(shadow.fi) + 'px',
				mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.dL)
			]));
};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					elm$core$String$fromFloat(shadow.fi) + 'px'),
					elm$core$Maybe$Just(
					mdgriffith$elm_ui$Internal$Model$formatColor(shadow.dL))
				])));
};
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {ds: almostShade.ds, dL: almostShade.dL, ct: false, eP: almostShade.eP, fi: almostShade.fi};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var mdgriffith$elm_ui$Element$Font$center = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.fz);
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								ds: 10,
								dL: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.16),
								eP: _Utils_Tuple2(4, 4),
								fi: 5
							})
						])),
					_Utils_Tuple2(
...
var author$project$TablePlugin$emptyDocTable = {w: elm$core$Maybe$Nothing, E: 'bleu-blanc', d0: elm$core$Array$empty, bq: '', aR: 1, eK: 0, aC: '', eL: 0, aD: '', ao: false, ap: false, a9: ''};
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					...
					true,
					{x: nodeList, r: nodeListSize, u: jsArray});
			} else {
...
var author$project$TablePlugin$init = function (mbTableMeta) {
	if (mbTableMeta.$ === 1) {
		...
		var style = mbTableMeta.a.fr;
		var nbrRows = mbTableMeta.a.eL;
		var nbrCols = mbTableMeta.a.eK;
		var data = mbTableMeta.a.d0;
		return _Utils_eq(data, _List_Nil) ? author$project$TablePlugin$emptyDocTable : {
			w: elm$core$Maybe$Nothing,
			E: style,
			d0: elm$core$Array$fromList(data),
			bq: '',
			aR: 1,
			eK: nbrCols,
			aC: '',
...
var author$project$TextBlockPlugin$defmeta = F2(
	function (uid, value) {
		return {s: 0, af: 0, aM: uid, O: value};
	});
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cc: col, dU: contextStack, cO: problem, cX: row};
	});
...
var elm$parser$Parser$Advanced$chompUntil = function (_n0) {
	...
	var expecting = _n0.b;
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$findSubString, str, s.eP, s.cX, s.cc, s.fn);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			_Utils_cmp(s.eP, newOffset) < 0,
			0,
			{cc: newCol, g: s.g, j: s.j, eP: newOffset, cX: newRow, fn: s.fn});
	};
};
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			elm$parser$Parser$Advanced$AddRight,
			elm$parser$Parser$Advanced$Empty,
			A4(elm$parser$Parser$Advanced$DeadEnd, s.cX, s.cc, x, s.g));
	});
var elm$parser$Parser$Advanced$end = function (x) {
	return function (s) {
		return _Utils_eq(
			elm$core$String$length(s.fn),
			s.eP) ? A3(elm$parser$Parser$Advanced$Good, false, 0, s) : A2(
			elm$parser$Parser$Advanced$Bad,
			false,
		...
		return function (s0) {
			...
			if (_n1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3(elm$core$String$slice, s0.eP, s1.eP, s0.fn),
						a),
					s1);
			}
		};
...
var elm$parser$Parser$Advanced$getOffset = function (s) {
	return A3(elm$parser$Parser$Advanced$Good, false, s.eP, s);
};
...
var elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {cc: s.cc + (newOffset - s.eP), g: s.g, j: s.j, eP: newOffset, cX: s.cX, fn: s.fn};
	});
...
var elm$parser$Parser$Advanced$finalizeFloat = F6(
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		var floatOffset = A2(elm$parser$Parser$Advanced$consumeDotAndExp, intOffset, s.fn);
		if (floatOffset < 0) {
			return A2(
				elm$parser$Parser$Advanced$Bad,
				true,
				A4(elm$parser$Parser$Advanced$fromInfo, s.cX, s.cc - (floatOffset + s.eP), invalid, s.g));
		} else {
			if (_Utils_eq(s.eP, floatOffset)) {
				return A2(
					elm$parser$Parser$Advanced$Bad,
					false,
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					return A5(elm$parser$Parser$Advanced$finalizeInt, invalid, intSettings, s.eP, intPair, s);
				} else {
					if (floatSettings.$ === 1) {
						...
						var _n1 = elm$core$String$toFloat(
							A3(elm$core$String$slice, s.eP, floatOffset, s.fn));
						if (_n1.$ === 1) {
							return A2(
								elm$parser$Parser$Advanced$Bad,
								true,
...
var elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3(elm$parser$Parser$Advanced$isAsciiCode, 48, s.eP, s.fn)) {
			var zeroOffset = s.eP + 1;
			var baseOffset = zeroOffset + 1;
			return A3(elm$parser$Parser$Advanced$isAsciiCode, 120, zeroOffset, s.fn) ? A5(
				elm$parser$Parser$Advanced$finalizeInt,
				c.ey,
				c.cp,
				baseOffset,
				A2(elm$parser$Parser$Advanced$consumeBase16, baseOffset, s.fn),
				s) : (A3(elm$parser$Parser$Advanced$isAsciiCode, 111, zeroOffset, s.fn) ? A5(
				elm$parser$Parser$Advanced$finalizeInt,
				c.ey,
				c.cD,
				baseOffset,
				A3(elm$parser$Parser$Advanced$consumeBase, 8, baseOffset, s.fn),
				s) : (A3(elm$parser$Parser$Advanced$isAsciiCode, 98, zeroOffset, s.fn) ? A5(
				elm$parser$Parser$Advanced$finalizeInt,
				c.ey,
				c.b8,
				baseOffset,
				A3(elm$parser$Parser$Advanced$consumeBase, 2, baseOffset, s.fn),
				s) : A6(
			...
			return A6(
				...
				c.cu,
				c.ck,
				A3(elm$parser$Parser$Advanced$consumeBase, 10, s.eP, s.fn),
				s);
		}
	};
};
...
var elm$parser$Parser$Advanced$keyword = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, kwd, s.eP, s.cX, s.cc, s.fn);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
	...
	function (isGood, offset, row, col, s0) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.eP, offset) < 0,
					0,
					{cc: col, g: s0.g, j: s0.j, eP: offset, cX: row, fn: s0.fn});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.eP, s.cX, s.cc, s);
	};
};
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.eP, s.cX, s.cc, s.fn);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
		...
		return function (d) {
			...
			function (tds) {
				...
				A2(
					elm$core$List$map,
					function (td) {
						return _Utils_Tuple2(td.a2.aM, td);
					},
					newTrackedDataList)));
	});
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cc: col, cO: problem, cX: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.cX, p.cc, p.cO);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{cc: 1, g: _List_Nil, j: 1, eP: 0, cX: 1, fn: src});
		if (!_n1.$) {
			var value = _n1.b;
			return elm$core$Result$Ok(value);
		} else {
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cl: fragment, cq: host, cL: path, cN: port_, cR: protocol, cS: query};
	});
...
var author$project$Editor$init = F2(
	function (doc, flags) {
		var handlers = {
			dD: author$project$Editor$EditCell,
			dP: author$project$Editor$SelectDoc,
			dQ: function (_n3) {
		...
		var config = {
			...
			fj: elm$core$Dict$fromList(
				A2(
					...
					idsToTrack)),
			fs: author$project$StyleSheets$defaulStyleSheet,
			fZ: 1920,
			f$: elm$core$Maybe$Just(handlers)
		};
		return _Utils_Tuple2(
			{
				...
				R: 0,
				aJ: author$project$TablePlugin$init(elm$core$Maybe$Nothing),
				aK: newTextBlockPlugin,
				ag: _List_Nil
			},
...
var author$project$Document$hasUid = F2(
	function (id, document) {
		if (!document.$) {
			var nv = document.a;
			return _Utils_eq(id, nv.c.aM);
		} else {
			var lv = document.a;
			return _Utils_eq(id, lv.c.aM);
		}
	});
...
var author$project$DocumentZipper$zipLeft = function (_n0) {
	...
	if (!contexts.b) {
		...
		var left = contexts.a.bU;
		var right = contexts.a.b_;
		var cs = contexts.b;
			...
			return elm$core$Maybe$Just(
				{
					e: A2(
						elm$core$List$cons,
						{
							bU: elm$core$List$reverse(ds),
							y: parent,
							b_: A2(elm$core$List$cons, current, right)
						},
						cs),
					f: d
				});
			...
			return elm$core$Maybe$Just(
				{
					e: A2(
						elm$core$List$cons,
						{
							bU: elm$core$List$reverse(ds),
							y: parent,
							b_: A2(elm$core$List$cons, d, right)
						},
						cs),
					f: current
				});
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							aJ: author$project$TablePlugin$init(
			...
			A2(
				...
				function (mainContInfo) {
					return A2(
						elm$core$Task$andThen,
						function (el) {
							return A3(elm$browser$Browser$Dom$setViewportOf, 'documentContainer', 0, (el.cf.c9 - mainContInfo.cf.c9) - 50);
						},
...
var author$project$TablePlugin$toTableMeta = function (docTable) {
	return {
		d0: elm$core$Array$toList(docTable.d0),
		eK: docTable.eK,
		eL: docTable.eL,
		fr: docTable.E
	};
...
var elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {x: builder.x, r: builder.r, u: appended});
	});
		...
		switch (msg.$) {
			...
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{w: elm$core$Maybe$Nothing, ap: !model.ap}),
					elm$core$Maybe$Nothing);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var nbrRows = function (n) {
					return (_Utils_cmp(n, author$project$TablePlugin$maxRows) < 1) ? n : model.eL;
				}(
					A2(
				...
				var nbrCols = function (n) {
					return (_Utils_cmp(n, author$project$TablePlugin$maxCols) < 1) ? n : model.eK;
				}(
					A2(
						elm$core$Maybe$withDefault,
						0,
						elm$core$String$toInt(model.aC)));
				var data = A2(author$project$TablePlugin$makeDataGrid, nbrRows, nbrCols);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{d0: data, eK: nbrCols, aC: '', eL: nbrRows, aD: '', ao: true}),
					elm$core$Maybe$Nothing);
			case 6:
				var _n2 = msg.a;
				var i = _n2.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							d0: function () {
								var _n3 = A2(elm$core$Array$get, i, model.d0);
								if (_n3.$ === 1) {
									return model.d0;
								} else {
									var a = _n3.a;
					...
					var newData = elm$core$Array$fromList(
						A2(
							...
							A2(
								...
								elm$core$Array$toIndexedList(model.d0))));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{w: elm$core$Maybe$Nothing, d0: newData, eL: model.eL + 1}),
						elm$core$Maybe$Nothing);
				}
			case 9:
				var _n7 = model.w;
				if (_n7.$ === 1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{w: elm$core$Maybe$Nothing, d0: newData, eK: model.eK - 1}),
						elm$core$Maybe$Nothing);
				}
			case 10:
				var direction = msg.a;
				...
				if (_n10.b.$ === 1) {
						...
						case 0:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										d0: A2(elm$core$Array$append, newRow, model.d0),
										eL: model.eL + 1
									}),
								elm$core$Maybe$Nothing);
						case 1:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										d0: A2(elm$core$Array$push, newRow, model.d0),
										eL: model.eL + 1
									}),
								elm$core$Maybe$Nothing);
						case 2:
					...
					switch (_n10.a) {
						case 0:
							...
							var i = _n20.a;
							var j = _n20.b;
							var topHalf = A3(elm$core$Array$slice, 0, i, model.d0);
							var newRow = elm$core$Array$fromList(
								_List_fromArray(
									[
										A2(
							...
							var bottomHalf = A3(elm$core$Array$slice, i, model.eL, model.d0);
							var newData = A2(
								elm$core$Array$append,
								topHalf,
						...
						case 1:
							...
							var i = _n22.a;
							var j = _n22.b;
							var topHalf = A3(elm$core$Array$slice, 0, i + 1, model.d0);
							var newRow = elm$core$Array$fromList(
								_List_fromArray(
									[
										A2(
							...
							var bottomHalf = A3(elm$core$Array$slice, i + 1, model.eL, model.d0);
							var newData = A2(
								elm$core$Array$append,
								topHalf,
								A2(elm$core$Array$append, newRow, bottomHalf));
						...
						case 2:
							...
							var addNewCell = function (row) {
								var rightHalf = A3(elm$core$Array$slice, j, model.eK, row);
							...
							var newData = A2(elm$core$Array$map, addNewCell, model.d0);
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{w: elm$core$Maybe$Nothing, d0: newData, eK: model.eK + 1}),
						...
						default:
							...
							var j = _n26.b;
							var addNewCell = function (row) {
								var rightHalf = A3(elm$core$Array$slice, j + 1, model.eK, row);
	...
	function (mbCursorPos, trackedDataDict) {
		if (mbCursorPos.$ === 1) {
			...
			var isCursorInTrackedData = function (td) {
				return (_Utils_cmp(cursorPos, td.a2.s) > -1) && (_Utils_cmp(cursorPos, td.a2.af) < 0);
			};
...
var author$project$TextBlockPlugin$insertTagHelper = F4(
	function (rawInput, selection, nextUid, tagname) {
		if (selection.$ === 1) {
			...
			var start = selection.a.s;
			var finish = selection.a.aQ;
			var sel = selection.a.c_;
...
var author$project$TextBlockPlugin$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (!_n1.$) {
					...
					return _Utils_Tuple3(
						_Utils_update(
							model,
							{
								p: A2(author$project$TextBlockPlugin$getSelectedTrackedData, model.aO, newTrackedData),
			...
			case 1:
				var tdKind = msg.a;
				var _n2 = A4(author$project$TextBlockPlugin$insertTrackingTag, model.aH, model.D, model.m, tdKind);
				if (_n2.$ === 1) {
					return _Utils_Tuple3(model, elm$core$Platform$Cmd$none, elm$core$Maybe$Nothing);
				} else {
			...
			case 2:
				...
				return _Utils_Tuple3(
					_Utils_update(
						model,
						{
							p: _Utils_eq(s.s, s.aQ) ? A2(
								author$project$TextBlockPlugin$getSelectedTrackedData,
								elm$core$Maybe$Just(s.s),
								model.a) : elm$core$Maybe$Nothing,
							aO: _Utils_eq(s.s, s.aQ) ? elm$core$Maybe$Just(s.s) : elm$core$Maybe$Nothing,
							D: _Utils_eq(s.s, s.aQ) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(s),
							aV: _Utils_eq(s.s, s.aQ) ? A2(
								elm$core$Maybe$map,
								function (td) {
									return A2(author$project$TextBlockPlugin$encodeSelection, td.a2.s, td.a2.af);
								},
								A2(
									author$project$TextBlockPlugin$getSelectedTrackedData,
									elm$core$Maybe$Just(s.s),
...
var author$project$Editor$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							n: _Utils_update(
								ws,
								{
									ei: elm$core$Basics$round(vp.bF.ei),
									fZ: elm$core$Basics$round(vp.bF.fZ)
								})
						}),
					elm$core$Platform$Cmd$none);
			case 1:
				...
				var res = msg.b;
				if (!res.$) {
					var viewport = res.a.bF;
					var currentConfig = model.n;
					var newSizesDict = A3(
						elm$core$Dict$insert,
						uid,
						{
							d4: elm$core$Basics$round(viewport.ei),
							d5: elm$core$Basics$round(viewport.fZ)
						},
						currentConfig.fj);
					return _Utils_Tuple2(
						_Utils_update(
						...
						_Utils_update(
							model,
							{
								n: _Utils_update(
									currentConfig,
									{
										eE: elm$core$Basics$round(viewport.ei)
									})
							}),
						elm$core$Platform$Cmd$none);
				} else {
			...
			case 21:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							at: elm$core$Maybe$Just(currentDoc),
							b: A2(elm$core$Maybe$withDefault, model.b, newDoc),
							m: model.m + 1,
							ag: A2(
								elm$core$List$take,
			...
			case 29:
				var tableMsg = msg.a;
				var _n14 = A2(author$project$TablePlugin$update, tableMsg, model.aJ);
				...
				if (mbPluginData.$ === 1) {
					...
					if (!mbPluginData.a.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{I: elm$core$Maybe$Nothing, aJ: newTablePlugin}),
							elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										author$project$Editor$scrollTo(
						...
						if (_n17.$ === 1) {
							...
							if (cellContent.$ === 1) {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{I: elm$core$Maybe$Nothing, b: newDoc}),
									elm$core$Platform$Cmd$batch(
										_List_fromArray(
											[
												author$project$Editor$scrollTo(
			...
			case 30:
				...
				var _n19 = A2(author$project$TextBlockPlugin$update, textBlockMsg, model.aK);
				...
				if (mbPluginData.$ === 1) {
					...
					if (!mbPluginData.a.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{I: elm$core$Maybe$Nothing, aK: newTextBlockPlugin}),
							elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										author$project$Editor$scrollTo(
...
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.aj);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ee);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cI);
...
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cX);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.fh);
	...
	switch (style.$) {
		...
		case 7:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.dN)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.fl.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.fl.b)))))));
		case 8:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.cX) + ('-' + (elm$core$String$fromInt(pos.cc) + ('-' + (elm$core$String$fromInt(pos.fZ) + ('-' + elm$core$String$fromInt(pos.ei)))))));
		case 10:
							...
							mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
								{
									...
									eP: A2(
										...
										A2(elm$core$Tuple$mapFirst, elm$core$Basics$toFloat, shadow.eP)),
									fi: shadow.fi
								}));
					},
					focus.ff),
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.ek, mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.ek, mdgriffith$elm_ui$Internal$Style$classes.aF)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.ed, mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.ed, mdgriffith$elm_ui$Internal$Style$classes.aF)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.bH, mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.bH, mdgriffith$elm_ui$Internal$Style$classes.aF)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.dn) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cX) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.dn) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.dn) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cX) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.dn) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bj) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
var mdgriffith$elm_ui$Internal$Style$Intermediate = elm$core$Basics$identity;
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bi: closing, C: _List_Nil, an: _List_Nil, ae: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								C: A2(
									elm$core$List$cons,
									{bi: '\n}', C: _List_Nil, an: props, ae: '@supports (' + (prop + (':' + (value + (') {' + parent.ae))))},
									rendered.C)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.ae + ('{' + (renderValues(rule.an) + (rule.bi + '}')));
		}
	};
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var single = '.' + mdgriffith$elm_ui$Internal$Style$classes.fh;
						var row = '.' + mdgriffith$elm_ui$Internal$Style$classes.cX;
					...
					case 8:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									'-ms-grid-row: ' + (elm$core$String$fromInt(position.cX) + ';'),
									'-ms-grid-row-span: ' + (elm$core$String$fromInt(position.ei) + ';'),
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.cX) + (' / ' + (elm$core$String$fromInt(position.cX + position.ei) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cc) + (' / ' + (elm$core$String$fromInt(position.cc + position.fZ) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.cX) + ('-' + (elm$core$String$fromInt(position.cc) + ('-' + (elm$core$String$fromInt(position.fZ) + ('-' + elm$core$String$fromInt(position.ei)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + mdgriffith$elm_ui$Internal$Style$classes.fh))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.bj, mdgriffith$elm_ui$Internal$Style$classes.ak, mdgriffith$elm_ui$Internal$Style$classes.dj])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.bj, mdgriffith$elm_ui$Internal$Style$classes.ak, mdgriffith$elm_ui$Internal$Style$classes.dh])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.bj, mdgriffith$elm_ui$Internal$Style$classes.di])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.bj, mdgriffith$elm_ui$Internal$Style$classes.dg])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.bD, mdgriffith$elm_ui$Internal$Style$classes.b2, mdgriffith$elm_ui$Internal$Style$classes.a0])))
			]),
		_List_fromArray(
			[
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.bI + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b6);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.bI + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b7);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.bI + (' ' + mdgriffith$elm_ui$Internal$Style$classes.de);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.bJ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dk);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.bJ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dd);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.bJ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.df);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
						mdgriffith$elm_ui$Internal$Style$classes.dn + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.cX + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
			...
			if (!elementAttrs.b) {
				...
				switch (attribute.$) {
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.co + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.dn + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.aj + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
					...
					case 9:
						...
						var newClasses = (location === 5) ? (mdgriffith$elm_ui$Internal$Style$classes.ef + (' ' + classes)) : classes;
										...
										switch (location) {
											case 0:
												return A2(
													...
													' ',
													_List_fromArray(
														[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.db]));
											case 1:
												return A2(
													elm$core$String$join,
													' ',
													_List_fromArray(
														[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.dr]));
											case 2:
												return A2(
													elm$core$String$join,
													' ',
													_List_fromArray(
														[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.eU]));
											case 3:
												return A2(
													elm$core$String$join,
													' ',
													_List_fromArray(
														[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.eR]));
											case 4:
												return A2(
													elm$core$String$join,
													' ',
													_List_fromArray(
														[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.et]));
											default:
												return A2(
													elm$core$String$join,
													' ',
													_List_fromArray(
														[mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh, mdgriffith$elm_ui$Internal$Style$classes.dq]));
										}
									}())
								]),
							_List_fromArray(
...
var author$project$DocumentStructView$docTreeView = F4(
	function (config, offsets, _n0, document) {
		...
		var labelFontColor = sel ? mdgriffith$elm_ui$Element$Font$color(
			...
			A4(mdgriffith$elm_ui$Element$rgba, 0.8, 0.8, 0.8, 1));
		if (!document.$) {
			var containerLabel = document.a.au;
			var id = document.a.c;
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.dT + (' ' + mdgriffith$elm_ui$Internal$Style$classes.a$)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var author$project$DocumentResponsive$flipTable = function (_n0) {
	...
	return {d0: newData, eK: nbrRows, eL: nbrCols, fr: style};
};
		...
		if (document.$ === 1) {
			...
			var imgsScaledToMinHeight = function () {
				...
				var scale = function (_n1) {
					...
					var attrs = _n1.v;
					var id = _n1.c;
					return {v: attrs, c: id, a2: meta, a3: mh + 5, aS: (mh * meta.fi.er) / meta.fi.eq};
				};
...
var mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		bh: (window.fZ <= 600) ? 0 : (((window.fZ > 600) && (window.fZ <= 1200)) ? 1 : (((window.fZ > 1200) && (window.fZ <= 1800)) ? 2 : 3)),
		cH: (_Utils_cmp(window.fZ, window.ei) < 0) ? 0 : 1
	};
};
	...
	function (config, document) {
		...
		if (!document.$) {
			...
			switch (containerLabel) {
								...
								return author$project$Document$Cell(
									{
										...
										c: _Utils_update(
											lId,
											{
												Y: A2(elm$core$Set$insert, 'colImg', lId.Y)
											})
									});
							} else {
								return l;
				...
				case 1:
					if (A2(author$project$Document$hasClass, 'sameHeightImgsRow', document) && A2(author$project$Document$containsOnly, author$project$Document$isImage, document)) {
						var _n4 = A2(elm$core$Dict$get, id.aM, config.fj);
						if (!_n4.$) {
							var docWidth = _n4.a.d5;
							var docHeight = _n4.a.d4;
				...
				case 2:
					return ((!device.bh) || (device.bh === 1)) ? A2(
			...
			switch (cellContent.$) {
				...
				case 1:
					var meta = cellContent.a;
					return (((!device.bh) || (device.bh === 1)) && (_Utils_cmp(meta.eK, meta.eL) > 0)) ? author$project$Document$Cell(
						{
							v: attrs,
...
var author$project$DocumentView$idStyle = F2(
	function (_n0, _n1) {
		var customStyles = _n0.d$;
		var uid = _n1.aM;
		var docStyleId = _n1.Z;
		var htmlId = _n1._;
		var classes = _n1.Y;
		return _Utils_ap(
			A2(
				...
				A2(
					...
					function (id) {
						return A2(elm$core$Dict$get, id, customStyles.em);
					},
					docStyleId)),
			_Utils_ap(
				A2(
				...
				elm$core$List$concat(
					A2(
						elm$core$List$filterMap,
						function (c) {
							return A2(elm$core$Dict$get, c, customStyles.Y);
						},
...
var mdgriffith$elm_ui$Element$Font$italic = mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.eA);
	...
	function (config, attrs) {
		...
		var renderAttr = function (attr) {
			switch (attr.$) {
				...
				case 2:
					return ((!device.bh) || (device.bh === 1)) ? _List_fromArray(
						[mdgriffith$elm_ui$Element$centerX]) : _Utils_ap(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$alignRight,
								mdgriffith$elm_ui$Element$paddingEach(
								{bM: 0, bU: 15, b_: 0, b0: 0})
							]),
							...
							case 4:
								return _List_fromArray(
									[
										...
										mdgriffith$elm_ui$Element$htmlAttribute(
										A2(elm$html$Html$Attributes$style, 'transition', '0.3s')),
										mdgriffith$elm_ui$Element$Events$onDoubleClick(handlers.dD)
									]);
							default:
								return _List_fromArray(
									[
	...
	function (config, id, attrs, s) {
		return _List_fromArray(
			[
				...
				A2(elm$core$Dict$get, s, config.d_))
			]);
	});
		...
		return _List_fromArray(
			[
				...
				_Utils_ap(
					...
					_Utils_ap(
						A2(author$project$DocumentView$idStyle, config.fs, id),
	...
	function (config, id, attrs, _n0) {
		...
		var attrs_ = _Utils_ap(
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(
					A2(mdgriffith$elm_ui$Element$maximum, size.er, mdgriffith$elm_ui$Element$fill))
				]),
			_Utils_ap(
				config.fs.ep,
				_Utils_ap(
...
var mdgriffith$elm_ui$Element$tableHelper = F2(
	function (attrs, config) {
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Internal$Model$GridPosition(
								{cc: columnLevel, ei: 1, cX: rowLevel, fZ: 1}))
						]),
					mdgriffith$elm_ui$Internal$Model$Unkeyed(
						_List_fromArray(
							[elem])));
		...
		var maybeHeaders = function (headers) {
			...
			A2(elm$core$List$map, columnHeader, config.dN));
		var add = F3(
						...
						cursor,
						{
							...
							av: A2(
								...
								A3(
									...
									A2(
										col.fY,
										_Utils_eq(maybeHeaders, elm$core$Maybe$Nothing) ? (cursor.cX - 1) : (cursor.cX - 2),
										cell)),
								cursor.av)
						});
				} else {
		...
		var children = A3(
			...
			build(config.dN),
			{
				aj: 1,
				av: _List_Nil,
				cX: _Utils_eq(maybeHeaders, elm$core$Maybe$Nothing) ? 1 : 2
			},
			config.d0);
		var _n0 = A2(
		...
		var template = A2(
			...
			mdgriffith$elm_ui$Internal$Model$GridTemplateStyle(
				{
					dN: A2(elm$core$List$map, columnWidth, config.dN),
					e9: A2(
						elm$core$List$repeat,
						elm$core$List$length(config.d0),
			...
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				function () {
					if (maybeHeaders.$ === 1) {
						...
						return _Utils_ap(renderedHeaders, children.av);
					}
				}()));
	});
var mdgriffith$elm_ui$Element$indexedTable = F2(
	function (attrs, config) {
		return A2(
			...
			attrs,
			{
				dN: A2(elm$core$List$map, mdgriffith$elm_ui$Element$InternalIndexedColumn, config.dN),
				d0: config.d0
			});
	});
...
var author$project$DocumentView$renderTable = F4(
	function (config, id, attrs, _n0) {
		...
		var columns = A2(
			...
			function (ci) {
				return {
					eg: mdgriffith$elm_ui$Element$none,
					fY: F2(
						function (ri, row) {
							return A2(
								mdgriffith$elm_ui$Element$el,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.bl + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ak)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
			...
			return A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						A2(author$project$DocumentView$renderAttrs, config, attrs))),
				{
					eC: mdgriffith$elm_ui$Element$text(label),
					fX: url
				});
		}
	});
		...
		switch (tbe.$) {
			...
			case 2:
				...
				var headingStyle = A2(
					elm$core$Maybe$withDefault,
					_List_Nil,
					A2(elm$core$Dict$get, level, config.fs.eh));
				return A2(
					mdgriffith$elm_ui$Element$paragraph,
					_Utils_ap(
						_List_fromArray(
	...
	function (_class, document) {
		var newId = function (id) {
			return _Utils_update(
				id,
				{
					Y: A2(elm$core$Set$member, _class, id.Y) ? A2(elm$core$Set$remove, _class, id.Y) : A2(elm$core$Set$insert, _class, id.Y)
				});
		};
		if (!document.$) {
			var nv = document.a;
		...
		var newCell = author$project$Document$Cell(
			_Utils_update(
				lv,
				{
					v: A2(
						elm$core$List$cons,
						A2(author$project$Document$ZipperAttr, id.aM, 4),
						attrs)
				}));
...
var author$project$Editor$mainMenu = function (config) {
	var menuEntry = function (_n1) {
		...
		var icon = _n1.cr;
		var isActive = _n1.k;
		var isSelected = _n1.az;
		var isSelectable = _n1.aa;
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(
				_List_fromArray(
	...
	var topEntry = function (_n0) {
		...
		return A2(
			...
			_Utils_ap(
				...
				(config.bN && _Utils_eq(config.bP, label)) ? _List_fromArray(
					[
	...
	var defEntry = {cr: elm$core$Maybe$Nothing, k: true, aa: false, az: false, eC: '', l: author$project$Editor$NoOp};
			...
			_List_fromArray(
				[
					...
					[
						_Utils_update(
						defEntry,
						{k: false && (!config.q), eC: 'Ouvrir page'}),
						_Utils_update(
						defEntry,
						{k: false && (!config.q), eC: 'Sauvegarder'})
					]),
					_List_fromArray(
					[
						_Utils_update(
						defEntry,
						{k: false && (!config.q), eC: 'Retour menu principal'})
					])
				])),
			_Utils_Tuple2(
			'Mise en page',
			_List_fromArray(
				[
					...
					[
						_Utils_update(
						defEntry,
						{k: !config.q, eC: 'Copier', l: author$project$Editor$Copy}),
						_Utils_update(
						defEntry,
						{k: !config.q, eC: 'Couper', l: author$project$Editor$Cut}),
						_Utils_update(
						defEntry,
						{k: (!config.bO) && (!config.q), eC: 'Coller', l: author$project$Editor$Paste})
					]),
					_List_fromArray(
					[
						_Utils_update(
						defEntry,
						{k: (!config.b1) && (!config.q), eC: 'Annuler', l: author$project$Editor$Undo})
					]),
					_List_fromArray(
					[
						_Utils_update(
						defEntry,
						{k: (!config.q) && (!config.W), eC: 'Supprimer'}),
						_Utils_update(
						defEntry,
						{k: (!config.q) && ((!config.a7) && (!config.W)), eC: 'Modifier selection', l: author$project$Editor$EditCell})
					])
				])),
			_Utils_Tuple2(
			'Affichage',
			_List_fromArray(
				[
					...
					[
						_Utils_update(
						defEntry,
						{k: false, aa: true, eC: 'Structure du document'}),
						_Utils_update(
						defEntry,
						{k: false, aa: true, eC: 'Editeur de feuille de style'})
					]),
					_List_fromArray(
					[
						_Utils_update(
					...
					[
						_Utils_update(
						defEntry,
						{aa: true, az: config.dS, eC: 'Couleurs conteneurs', l: author$project$Editor$ToogleCountainersColors})
					])
				])),
			_Utils_Tuple2(
			'Aide',
	...
	var interfaceButton = function (buttonConfig) {
		return A2(
			...
			menuButtonStyle(buttonConfig.k),
			{
				...
				eT: buttonConfig.k ? buttonConfig.l : elm$core$Maybe$Nothing
			});
	};
	var defButtonConfig = {Q: _List_Nil, k: !config.q, L: '', l: elm$core$Maybe$Nothing};
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							eC: mdgriffith$elm_ui$Element$text('Modifier'),
							eT: elm$core$Maybe$Just(author$project$TablePlugin$SwapDisplayMode)
						})
					]))
			]));
	var dataForTable = elm$core$Array$toList(model.d0);
	var columns = A2(
		elm$core$List$map,
		function (ci) {
			return {
		...
		A2(elm$core$List$range, 0, model.eK - 1));
	var tableView = model.ao ? A2(
		...
		A2(
			...
			A2(
				...
				A2(elm$core$Dict$get, model.E, author$project$StyleSheets$tableStyles))),
		{dN: columns, d0: dataForTable}) : mdgriffith$elm_ui$Element$none;
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		var _n0 = function () {
			...
			if (!_n1.$) {
				...
				var _n3 = A3(
					...
					{T: _List_Nil, a0: elm$core$Maybe$Nothing, br: elm$core$Maybe$Nothing, bs: elm$core$Maybe$Nothing},
					attributes);
									...
									return mdgriffith$elm_ui$Element$paddingEach(
										{
											...
											bU: l,
											b_: r,
											b0: A2(elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
									...
									if (heightContent.a.$ === 1) {
										...
										var newlineCount = function (x) {
											...
											elm$core$List$length(
												elm$core$String$lines(textOptions.bD)));
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.eN + (' ' + mdgriffith$elm_ui$Internal$Style$classes.e0)),
																mdgriffith$elm_ui$Element$Border$color(
		...
		_List_fromArray(
			[
					...
					]),
				{
					...
					bu: author$project$TablePlugin$SetStyle,
...
var mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{P: elm$core$Maybe$Nothing, S: multi.fm, X: mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{eC: multi.eC, bu: multi.bu, bA: multi.bA, bD: multi.bD});
	});
							...
							A2(
								...
								_Utils_Tuple2(
									...
									A2(
										...
										{
											eC: A2(mdgriffith$elm_ui$Element$Input$labelAbove, _List_Nil, mdgriffith$elm_ui$Element$none),
											bu: author$project$TablePlugin$DataInput(
												_Utils_Tuple2(ri, ci)),
	...
	var tableView = model.ao ? A2(
		...
		A2(
			...
			A2(
				...
				A2(elm$core$Dict$get, model.E, author$project$StyleSheets$tableStyles))),
		{dN: columns, d0: dataForTable}) : mdgriffith$elm_ui$Element$none;
	var canRemove = A2(author$project$TablePlugin$focusIsValid, model.w, model.d0);
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Aperçu'),
							eT: elm$core$Maybe$Just(author$project$TablePlugin$SwapDisplayMode)
						}),
						...
						{
							eC: mdgriffith$elm_ui$Element$text('Supprimer ligne'),
							eT: canRemove ? elm$core$Maybe$Just(author$project$TablePlugin$RemoveSelectedRow) : elm$core$Maybe$Nothing
						}),
						A2(
						mdgriffith$elm_ui$Element$Input$button,
						author$project$TablePlugin$buttonStyle(canRemove),
						{
							eC: mdgriffith$elm_ui$Element$text('Supprimer colonne'),
							eT: canRemove ? elm$core$Maybe$Just(author$project$TablePlugin$RemoveSelectedCol) : elm$core$Maybe$Nothing
						})
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Insérer au dessus'),
							eT: elm$core$Maybe$Just(
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Insérer en dessous'),
							eT: elm$core$Maybe$Just(
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Insérer à gauche'),
							eT: elm$core$Maybe$Just(
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Insérer à droite'),
							eT: elm$core$Maybe$Just(
				...
				_List_fromArray(
					[
						...
						author$project$TablePlugin$textInputStyle,
						{
							...
							bu: author$project$TablePlugin$SetNbrCols,
							bA: elm$core$Maybe$Nothing,
							bD: model.aC
						}),
						A2(
						...
						author$project$TablePlugin$textInputStyle,
						{
							...
							bu: author$project$TablePlugin$SetNbrRows,
							bA: elm$core$Maybe$Nothing,
							bD: model.aD
						}),
						A2(
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Créer table'),
							eT: elm$core$Maybe$Just(author$project$TablePlugin$InitializeTable)
						})
					])),
				A2(
				mdgriffith$elm_ui$Element$el,
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Quitter'),
							eT: elm$core$Maybe$Just(author$project$TablePlugin$Quit)
						}),
						A2(
						mdgriffith$elm_ui$Element$Input$button,
						author$project$TablePlugin$buttonStyle(true),
						{
							eC: mdgriffith$elm_ui$Element$text('Valider et Quitter'),
							eT: elm$core$Maybe$Just(author$project$TablePlugin$SaveAndQuit)
						})
					])) : mdgriffith$elm_ui$Element$none
			]));
};
...
var author$project$TextBlockPlugin$Selection = F3(
	function (start, finish, sel) {
		return {aQ: finish, c_: sel, s: start};
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(meta.O))
						])),
					A2(
					mdgriffith$elm_ui$Element$Input$text,
					_List_fromArray(
						...
						]),
					{
						...
						bu: author$project$TextBlockPlugin$SetUrl(meta.aM),
						bA: elm$core$Maybe$Nothing,
						bD: url
					})
				]));
			...
			_List_fromArray(
				[
							...
							[mdgriffith$elm_ui$Element$alignTop])),
					{
						...
						eT: elm$core$Maybe$Just(
							author$project$TextBlockPlugin$ConfirmHeadingLevel(meta.aM))
					})
				]));
	});
			...
			_List_fromArray(
				[
						...
						true),
					{
						...
						eT: elm$core$Maybe$Just(
							author$project$TextBlockPlugin$SetInlineBold(meta.aM))
					}),
					A2(
					mdgriffith$elm_ui$Element$Input$button,
					A2(
						...
						true),
					{
						...
						eT: elm$core$Maybe$Just(
							author$project$TextBlockPlugin$SetInlineItalic(meta.aM))
					}),
					A2(
					mdgriffith$elm_ui$Element$el,
					_List_Nil,
						...
						A2(
							...
							_List_fromArray(
								[
									...
									author$project$TextBlockPlugin$SetInlineFont(meta.aM))
								]),
							A2(
								elm$core$List$map,
								fontOptionView(
					...
					mdgriffith$elm_ui$Element$html(
						A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onInput(
									author$project$TextBlockPlugin$SetInlineFontSize(meta.aM))
								]),
							A2(
								elm$core$List$map,
								fontSizeOptionView(
...
var mdgriffith$elm_ui$Element$clipX = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.dJ);
			...
			_List_fromArray(
				[
							...
							[mdgriffith$elm_ui$Element$alignTop])),
					{
						...
						eT: (!_Utils_eq(mbFile, elm$core$Maybe$Nothing)) ? elm$core$Maybe$Just(
			...
			_List_fromArray(
				[
							...
							[mdgriffith$elm_ui$Element$alignTop])),
					{
						...
						eT: (!_Utils_eq(mbSelected, elm$core$Maybe$Nothing)) ? elm$core$Maybe$Just(
				...
				switch (found) {
					case 0:
						return _Utils_eq(
							...
							input.D) ? _Utils_Tuple3(1, prev, nxt) : _Utils_Tuple3(found, val, nxt);
					case 1:
		...
		var optionArea = function () {
			if (!orientation) {
				return A2(
					...
					attrs,
					A2(elm$core$List$map, renderOption, input.eY));
			} else {
				return A2(
		...
		_List_fromArray(
			[
				...
				config.c$ ? A2(
					...
					_List_fromArray(
						[
							config.bT ? A4(author$project$TextBlockPlugin$chooseDocView, config.aX.a2.aM, config.aI, config.ac, config.cj) : A3(author$project$TextBlockPlugin$chooseInternalPageView, config.aX.a2.aM, config.ad, config.cJ)
						])) : mdgriffith$elm_ui$Element$none)
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$el,
						_List_Nil,
						mdgriffith$elm_ui$Element$text(config.aX.a2.O))
					])),
				A2(
				mdgriffith$elm_ui$Element$Input$text,
				_List_fromArray(
					...
					]),
				{
					eC: A2(
						...
						_List_fromArray(
							[mdgriffith$elm_ui$Element$centerY, mdgriffith$elm_ui$Element$Font$bold]),
						mdgriffith$elm_ui$Element$text('Url: ')),
					bu: author$project$TextBlockPlugin$SetUrl(config.aX.a2.aM),
					bA: elm$core$Maybe$Nothing,
					bD: config.fX
				}),
				A2(
				...
				{
					eC: A2(mdgriffith$elm_ui$Element$Input$labelLeft, _List_Nil, mdgriffith$elm_ui$Element$none),
					bu: author$project$TextBlockPlugin$SetInternalLinkKind(config.aX.a2.aM),
					eY: _List_fromArray(
						[
							A2(
							mdgriffith$elm_ui$Element$Input$option,
					...
					D: elm$core$Maybe$Just(config.bT)
				})
			]));
};
		...
		_List_fromArray(
			[
					...
					_Utils_eq(model.D, elm$core$Maybe$Nothing)),
				{
					...
					eT: elm$core$Maybe$Just(author$project$TextBlockPlugin$SetTextBlocAlignment)
				}),
				A2(
				mdgriffith$elm_ui$Element$Input$button,
				A2(
					...
					_Utils_eq(model.D, elm$core$Maybe$Nothing)),
				{
					...
					eT: elm$core$Maybe$Just(author$project$TextBlockPlugin$SetTextBlocBold)
				}),
				A2(
				mdgriffith$elm_ui$Element$Input$button,
				A2(
					...
					_Utils_eq(model.D, elm$core$Maybe$Nothing)),
				{
					...
					eT: elm$core$Maybe$Just(author$project$TextBlockPlugin$SetTextBlocItalic)
				})
			]));
};
							...
							switch (dataKind.$) {
								...
								case 0:
									...
									return author$project$TextBlockPlugin$internalLinkView(
										{cj: author$project$TextBlockPlugin$dummyFileList, bT: isDoc, cJ: author$project$TextBlockPlugin$dummyInternalPageList, ac: model.ac, aI: model.aI, ad: model.ad, c$: model.U, aX: td, fX: url});
								case 1:
									var url = dataKind.a;
		...
		return A2(
			...
			_Utils_ap(
				...
				model.U ? _List_fromArray(
					...
					]) : ((!_Utils_eq(model.H, elm$core$Maybe$Nothing)) ? _List_fromArray(
					[
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								eC: mdgriffith$elm_ui$Element$text('Quitter'),
								eT: elm$core$Maybe$Just(author$project$TextBlockPlugin$Quit)
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							author$project$TextBlockPlugin$buttonStyle(true),
							{
								eC: mdgriffith$elm_ui$Element$text('Valider et Quitter'),
								eT: elm$core$Maybe$Just(author$project$TextBlockPlugin$SaveAndQuit)
							})
						])),
					A2(
					mdgriffith$elm_ui$Element$paragraph,
		...
		switch (plugin) {
			...
			case 1:
				return A2(
					...
					author$project$TablePlugin$view(model.aJ));
			case 2:
				return A2(
					mdgriffith$elm_ui$Element$el,
					_List_Nil,
			...
			case 3:
				return A2(
					...
					A2(author$project$TextBlockPlugin$view, model.aK, model.n));
			default:
				return author$project$NewDocPlugin$view(
					{dV: author$project$Editor$CreateNewCell, dW: author$project$Editor$CreateNewContainer, m: model.m});
		}
	});
...
var mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	ff: elm$core$Maybe$Just(
		{
			ds: 3,
			dL: A4(mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
			eP: _Utils_Tuple2(0, 0),
			fi: 3
		})
};
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{ed: elm$core$Maybe$Nothing, ek: elm$core$Maybe$Nothing, aR: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.e7, mdgriffith$elm_ui$Internal$Style$classes.dn, mdgriffith$elm_ui$Internal$Style$classes.fh]))),
				...
				A2(
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
								mdgriffith$elm_ui$Element$height(
								A2(mdgriffith$elm_ui$Element$maximum, model.n.ei, mdgriffith$elm_ui$Element$fill))
							]),
					...
					_List_fromArray(
						[
							...
							{
								bN: model.aA,
								bO: _Utils_eq(model.at, elm$core$Maybe$Nothing),
								dS: model.n.dS,
								bP: model.bt,
								q: !_Utils_eq(model.I, elm$core$Maybe$Nothing),
								R: model.R,
								a7: author$project$Document$isContainer(
									author$project$DocumentZipper$extractDoc(model.b)),
								W: _Utils_eq(
									author$project$DocumentZipper$zipUp(model.b),
									elm$core$Maybe$Nothing),
								b1: _Utils_eq(model.ag, _List_Nil)
							}),
							A2(
							mdgriffith$elm_ui$Element$row,
							_List_fromArray(
...
var author$project$SampleDocs$sampleDoc1 = A2(
	...
	A2(
		author$project$Document$Container,
		{
			...
			au: 0,
			c: {
				Y: elm$core$Set$fromList(_List_Nil),
				Z: elm$core$Maybe$Just('root'),
				_: elm$core$Maybe$Just('mainContainer'),
				aM: 0
			}
		},
		_List_fromArray(
							...
							ai: author$project$Document$Image(
								{
									...
									fn: author$project$Document$UrlSrc('images/2 Murol, le bourg.jpg')
								}),
							c: {
								Y: elm$core$Set$fromList(_List_Nil),
								Z: elm$core$Maybe$Nothing,
							...
							ai: author$project$Document$Image(
								{
									...
									fn: author$project$Document$UrlSrc('images/illustration animations estivales.jpg')
								}),
							c: {
								Y: elm$core$Set$fromList(_List_Nil),
								Z: elm$core$Maybe$Nothing,
									...
									[
										...
										_List_fromArray(
											[
												...
												author$project$Document$Link,
												_List_Nil,
												{eC: 'musée des Peintres de l’Ecole de Murols', fx: true, fX: 'http://www.musee-murol.fr/fr'}),
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/famillePlus.jpg')
										}),
									c: {
										Y: elm$core$Set$fromList(_List_Nil),
										Z: elm$core$Maybe$Nothing,
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/Station_Tourisme_RVB.jpg')
										}),
									c: {
										Y: elm$core$Set$fromList(_List_Nil),
										Z: elm$core$Maybe$Nothing,
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/Village fleuri.png')
										}),
									c: {
										Y: elm$core$Set$fromList(_List_Nil),
										Z: elm$core$Maybe$Nothing,
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/StationVertegf.jpg')
										}),
									c: {
										Y: elm$core$Set$fromList(_List_Nil),
										Z: elm$core$Maybe$Nothing,
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/PAVILLON BLEU LOGO 2.png')
										}),
									c: {
										Y: elm$core$Set$fromList(
											_List_fromArray(
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/lac3.jpg')
										}),
									c: {
										Y: elm$core$Set$fromList(_List_Nil),
										Z: elm$core$Maybe$Nothing,
							...
							ai: author$project$Document$Image(
								{
									...
									fn: author$project$Document$UrlSrc('images/prélong.jpg')
								}),
							c: {
								Y: elm$core$Set$fromList(_List_Nil),
								Z: elm$core$Maybe$Nothing,
							...
							ai: author$project$Document$Image(
								{
									...
									fn: author$project$Document$UrlSrc('images/museePeintre.jpeg')
								}),
							c: {
								Y: elm$core$Set$fromList(_List_Nil),
								Z: elm$core$Maybe$Nothing,
							...
							ai: author$project$Document$Image(
								{
									...
									fn: author$project$Document$UrlSrc('images/bourg2.jpg')
								}),
							c: {
								Y: elm$core$Set$fromList(_List_Nil),
								Z: elm$core$Maybe$Nothing,
							...
							ai: author$project$Document$Image(
								{
									...
									fn: author$project$Document$UrlSrc('images/OT.jpg')
								}),
							c: {
								Y: elm$core$Set$fromList(_List_Nil),
								Z: elm$core$Maybe$Nothing,
									...
									ai: author$project$Document$Image(
										{
											...
											fn: author$project$Document$UrlSrc('images/sancy_hiver.jpg')
										}),
									c: {
										Y: elm$core$Set$fromList(_List_Nil),
										Z: elm$core$Maybe$Nothing,
...
var author$project$Editor$main = elm$browser$Browser$document(
	{
		ev: author$project$Editor$init(author$project$SampleDocs$sampleDoc1),
		fv: author$project$Editor$subscriptions,
