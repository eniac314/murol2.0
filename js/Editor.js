	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				(!model.hasRefreshed) ? elm$browser$Browser$Events$onAnimationFrame(
				function (_n0) {
...
var mdgriffith$stylish_elephants$Internal$Model$renderFocusStyle = function (focus) {
	return A2(
		...
		mdgriffith$stylish_elephants$Internal$Style$classes.any + (':focus .focusable, ' + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.any) + '.focusable:focus')),
		A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
			_List_fromArray(
						...
						return _Utils_eq(context, mdgriffith$stylish_elephants$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								A2(
									...
									_Utils_Tuple2('sp', mdgriffith$stylish_elephants$Internal$Model$space),
									htmls)),
							_Utils_ap(styled.styles, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
...
var mdgriffith$stylish_elephants$Element$image = F2(
	function (attrs, _n0) {
		...
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.imageContainer),
				attrs),
			mdgriffith$stylish_elephants$Internal$Model$Unkeyed(
				_List_fromArray(
					[
						...
						mdgriffith$stylish_elephants$Internal$Model$element,
						mdgriffith$stylish_elephants$Internal$Model$asEl,
						mdgriffith$stylish_elephants$Internal$Model$NodeName('img'),
						_Utils_ap(
							_List_fromArray(
								[
...
var author$project$DocumentView$renderImage = F5(
	function (winSize, onLoadMsg, _n0, attrs, _n1) {
		...
		return A2(
			...
			attrs_,
			{
				description: A2(elm$core$Maybe$withDefault, '', caption),
				src: src_
			});
	});
