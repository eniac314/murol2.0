...
var author$project$Main$CurrentViewport = function (a) {
	...
	function (flags, url, key) {
		return _Utils_Tuple2(
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2(elm$core$Task$perform, author$project$Main$CurrentViewport, elm$browser$Browser$Dom$getViewport)
					])));
	});
...
var author$project$Document$packStyleSheet = F2(
...
var author$project$Document$renderAttrs = F2(
	function (winSize, attrs) {
		...
		var renderAttr = function (attr) {
			switch (attr.$) {
				...
				case 'AlignRight':
					return ((_Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Phone) || _Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Tablet)) && _Utils_eq(device.orientation, mdgriffith$stylish_elephants$Element$Portrait)) ? _List_fromArray(
	...
	function (winSize, document) {
		...
		switch (document.$) {
			...
			case 'TextColumnNode':
				...
				var attrs = document.b;
				var children = document.c;
				return ((_Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Phone) || _Utils_eq(device._class, mdgriffith$stylish_elephants$Element$Tablet)) && _Utils_eq(device.orientation, mdgriffith$stylish_elephants$Element$Portrait)) ? A3(
					author$project$Document$ColumnNode,
					id,
					attrs,
					A2(
...
var author$project$Main$sampleDoc = A3(
	author$project$Document$ColumnNode,
	{
		classes: _List_Nil,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(author$project$Document$responsivePreFormat, model.winSize, author$project$Main$sampleDoc))))),
				elm$html$Html$text(
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlRequest: function (urlReq) {
			return _Debug_todo(
				'Main',
				{
					start: {line: 182, column: 37},
					end: {line: 182, column: 47}
				})('');
		},
