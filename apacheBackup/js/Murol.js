...
{
	if (region.c7.bA === region.dw.bA)
	{
		return 'on line ' + region.c7.bA;
	}
	return 'on lines ' + region.c7.bA + ' through ' + region.dw.bA;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.gT, request.db, true);
		} catch (e) {
...
{
	for (var headers = request.gh; headers.b; headers = headers.b) // WHILE_CONS
	{
		xhr.setRequestHeader(headers.a.a, headers.a.b);
	}
	xhr.timeout = request.iG.a || 0;
...
function _Http_toMetadata(xhr)
{
	return {
		...
		h8: xhr.status,
		h9: xhr.statusText,
		gh: _Http_parseHeaders(xhr.getAllResponseHeaders())
	};
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { gk: 'hidden', fm: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { gk: 'mozHidden', fm: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { gk: 'msHidden', fm: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { gk: 'webkitHidden', fm: 'webkitvisibilitychange' }
		: { gk: 'hidden', fm: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		eI: {
			...
			iR: _Browser_window.pageYOffset,
	...
	function (defaultOffset, posixMinutes, eras) {
		...
		while (true) {
			if (!eras.b) {
				...
				if (_Utils_cmp(era.c7, posixMinutes) < 0) {
					return posixMinutes + era.g6;
				} else {
...
var elm$time$Time$toMonth = F2(
	function (zone, time) {
		var _n0 = elm$time$Time$toCivil(
			A2(elm$time$Time$toAdjustedMinutes, zone, time)).gX;
		switch (_n0) {
			case 1:
				return 0;
			case 2:
...
var author$project$Internals$Streams$BiStream = F6(
	function (value, leftStr, rightStr, prev, size, index) {
		return {c$: index, bz: leftStr, a3: prev, bK: rightStr, es: size, eF: value};
	});
		...
		var stream = A2(
			...
			function (xs) {
				...
				A2(
					...
					imgs)));
		return {bu: 0, b8: externalMsg, cR: 0, p: stream, dX: elm$core$Set$empty, U: elm$core$Maybe$Nothing, A: elm$core$Maybe$Nothing};
	});
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{r: nodeList, j: (len / elm$core$Array$branchFactor) | 0, o: tail});
			} else {
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return elm$core$Result$Err(
					elm$http$Http$BadStatus(metadata.h8));
			default:
				var body = response.b;
				return A2(
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{a8: false, dl: r.dl, cP: r.cP, gh: r.gh, gT: r.gT, iG: r.iG, aa: r.aa, db: r.db}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{dl: r.dl, cP: r.cP, gh: _List_Nil, gT: 'POST', iG: elm$core$Maybe$Nothing, aa: elm$core$Maybe$Nothing, db: r.db});
};
...
var author$project$Murol$getPages = function () {
	...
	return elm$http$Http$post(
		{
			dl: body,
			cP: A2(elm$http$Http$expectJson, author$project$Murol$LoadPages, elm$json$Json$Decode$value),
			db: '/getPageTree.php'
		});
}();
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dD: fragment, dM: host, z: path, eb: port_, eg: protocol, eh: query};
	});
...
var author$project$Murol$init = F3(
	function (flags, url, key) {
		...
		var season = A2(
			...
			elm$time$Time$utc,
			elm$time$Time$millisToPosix(flags.fF));
		var config = {
			fz: false,
			fF: elm$time$Time$millisToPosix(flags.fF),
			fI: elm$core$Dict$empty,
			fV: false,
			f3: elm$core$Dict$empty,
			dI: flags.dI,
			gP: 0,
			g2: elm$core$Dict$empty,
			hd: author$project$Murol$ToogleFiche,
			he: author$project$Murol$ToogleNews,
			hf: elm$core$Set$empty,
			hg: elm$core$Set$empty,
			hk: elm$core$Dict$empty,
			hu: 1,
			hM: season,
			eJ: flags.eJ,
			iT: elm$core$Maybe$Nothing,
			df: elm$time$Time$utc
		};
		return _Utils_Tuple2(
			{
				b: config,
...
var author$project$Gallery$HeaderGallery$Animate = function (a) {
	return {$: 2, a: a};
};
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {c3: oldTime, ek: request, ev: subs};
	});
...
var author$project$Gallery$HeaderGallery$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				(!_Utils_eq(model.U, elm$core$Maybe$Nothing)) ? elm$core$Platform$Sub$none : elm$core$Platform$Sub$none,
				elm$browser$Browser$Events$onAnimationFrame(author$project$Gallery$HeaderGallery$Tick),
				A2(
				elm$time$Time$every,
				15000,
...
var elm$browser$Browser$Events$onSelfMsg = F3(
	function (router, _n0, state) {
		...
		var messages = A2(elm$core$List$filterMap, toMessage, state.ev);
		return A2(
			elm$core$Task$andThen,
			function (_n1) {
				return elm$core$Task$succeed(state);
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$Murol$HGmsg,
				author$project$Gallery$HeaderGallery$subscriptions(model.bg))
			]));
};
...
var mgold$elm_animation$Animation$AnimRecord = F7(
	function (start, delay_, dos, ramp, ease_, from_, to_) {
		return {D: delay_, v: dos, as: ease_, k: from_, aj: ramp, c7: start, g: to_};
	});
...
var mgold$elm_animation$Animation$speed = F2(
	function (x, _n0) {
		...
		return _Utils_update(
			a,
			{
				v: mgold$elm_animation$Animation$Speed(
...
var author$project$Gallery$HeaderGallery$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_update(
					model,
					{
						p: author$project$Internals$Streams$right(
							function ($) {
								return $.p;
							}(model)),
			...
			case 1:
				return _Utils_update(
					model,
					{
						p: author$project$Internals$Streams$left(
							function ($) {
								return $.p;
							}(model)),
						A: elm$core$Maybe$Nothing
			...
			case 2:
				...
				var newAnim = function () {
					var _n1 = _Utils_Tuple3(model.U, dir, model.A);
					if (((_n1.a.$ === 1) && (!_n1.b)) && (_n1.c.$ === 1)) {
						var _n2 = _n1.a;
						var _n3 = _n1.b;
						var _n4 = _n1.c;
						return elm$core$Maybe$Just(
									...
									A2(
										...
										A2(
											...
											A2(
												...
												0,
												mgold$elm_animation$Animation$animation(model.bu))))),
								0));
					} else {
						return elm$core$Maybe$Nothing;
					}
			...
			case 5:
				...
				if (!_n6.$) {
					...
					var start = _n7.a;
					var current_ = _n7.b;
					return ((start.ab - current_.ab) > 100) ? _Utils_update(
						model,
						{
							p: author$project$Internals$Streams$right(
								function ($) {
							...
							A: elm$core$Maybe$Nothing
						}) : ((_Utils_cmp(start.ab - current_.ab, -100) < 0) ? _Utils_update(
						model,
						{
							p: author$project$Internals$Streams$left(
								function ($) {
			...
			case 7:
				...
				return _Utils_update(
					model,
					{
						dX: A2(elm$core$Set$insert, src, model.dX)
					});
			case 6:
				var t = msg.a;
				...
				var _n8 = function () {
					...
					if (!_n9.$) {
						if (!_n9.a.b) {
							...
							return A2(mgold$elm_animation$Animation$isDone, newClock, anim) ? _Utils_Tuple2(
								...
								author$project$Internals$Streams$right(
									function ($) {
										return $.p;
									}(model))) : _Utils_Tuple2(model.U, model.p);
						} else {
							var _n12 = _n9.a;
							var anim = _n12.a;
							var _n13 = _n12.b;
						...
						return _Utils_Tuple2(model.U, model.p);
					}
				}();
				var newAnim = _n8.a;
				var newImages = _n8.b;
				return _Utils_update(
					model,
					{bu: newClock, cR: 0, p: newImages, U: newAnim});
			default:
				return model;
		}
	});
...
var author$project$PageTreeEditor$PageTreeEditor$PageInfo = F3(
	function (name, path, mbContentId) {
		return {gS: mbContentId, x: name, z: path};
	});
																...
																return function (linkedDocs) {
																	return function (ouverture) {
																		return function (lastEdit) {
																			return {eS: adresse, cG: categories, fS: description, fX: email, dB: fax, f: label, dU: lastEdit, gL: linkedDocs, g_: natureActiv, g4: nomEntite, hi: ouverture, ea: pjaun, hw: rank, hy: refOt, hC: responsables, h1: site, $9: telNumber, eE: uuid, iO: visuel};
																		};
																	};
																};
															};
...
var author$project$GeneralDirectoryEditor$GeneralDirCommonTypes$LinkedDoc = F4(
	function (url, label, descr, expiryDate) {
		return {fQ: descr, f_: expiryDate, f: label, db: url};
	});
...
var author$project$Document$Document$LinkMeta = F3(
	function (targetBlank, url, label) {
		return {f: label, ex: targetBlank, db: url};
	});
...
var author$project$Document$Document$CellValue = F3(
	function (cellContent, id, attrs) {
		return {h: attrs, P: cellContent, a: id};
	});
...
var author$project$Document$Document$EmptyCell = {$: 13};
...
var author$project$Document$Document$BlockLinkMeta = F4(
	function (image, label, targetBlank, url) {
		return {gq: image, f: label, ex: targetBlank, db: url};
	});
...
var author$project$Document$Document$TableMeta = F4(
	function (style, nbrRows, nbrCols, data) {
		return {fK: data, g$: nbrCols, g0: nbrRows, id: style};
	});
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					elm$core$Array$builderToArray,
					true,
					{r: nodeList, j: nodeListSize, o: jsArray});
			} else {
...
var author$project$Document$Document$VideoMeta = F9(
	function (src, size, frameBorder, suggestions, controls, privacy, title, startAt, hosting) {
		return {fD: controls, f8: frameBorder, gl: hosting, hv: privacy, es: size, eu: src, h7: startAt, ih: suggestions, da: title};
	});
...
var author$project$Document$Document$VideoSize = F2(
	function (videoWidth, videoHeight) {
		return {iK: videoHeight, iL: videoWidth};
	});
...
var author$project$Document$Document$Id = F4(
	function (uid, docStyleId, htmlId, classes) {
		return {an: classes, ar: docStyleId, av: htmlId, bR: uid};
	});
...
var author$project$Document$Document$ContainerValue = F3(
	function (containerLabel, id, attrs) {
		return {h: attrs, ao: containerLabel, a: id};
	});
...
var author$project$PageTreeEditor$PageTreeEditor$Content = F3(
	function (contentId, jsonContent, docContent) {
		return {fA: contentId, fT: docContent, dT: jsonContent};
	});
...
var author$project$Murol$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 0:
				var url = msg.a;
				var _n2 = A2(elm$core$Dict$get, url.z, model.ah);
				if (!_n2.$) {
					if (!_n2.a.c.$) {
						var _n3 = _n2.a;
						var cId = _n3.a;
							...
							_Utils_update(
								model,
								{
									b: _Utils_update(
										config,
										{hk: pageIndex}),
									bH: elm$core$Maybe$Just(pageTree),
									ah: pages
								}),
							function () {
								var _n9 = A2(elm$core$Dict$get, model.db.z, pages);
								if (!_n9.$) {
									if (!_n9.a.c.$) {
										var _n10 = _n9.a;
										var cId = _n10.a;
										...
										return author$project$Murol$getContent(
											_Utils_Tuple3(model.db.z, cId, name));
									} else {
			...
			case 2:
				...
				if (!res.$) {
					...
					if (!_n15.$) {
						var contentId = _n15.a.fA;
						var docContent = _n15.a.fT;
						var fichesIds = author$project$Document$Document$gatherFichesIds(docContent);
						var fichesToDownload = A3(
							elm$core$List$foldr,
							F2(
								function (id, acc) {
									return A2(elm$core$Dict$member, id, model.b.f3) ? acc : A2(elm$core$List$cons, id, acc);
								}),
							_List_Nil,
							fichesIds);
						return _Utils_Tuple2(
					...
					var newFiches = A3(
						...
						F2(
							function (f, acc) {
								return A3(
									elm$core$Dict$insert,
									TSFoster$elm_uuid$UUID$canonical(f.eE),
									f,
									acc);
							}),
						config.f3,
					...
					var newsDict = A3(
						...
						F2(
							function (n, acc) {
								return A3(
									elm$core$Dict$insert,
									TSFoster$elm_uuid$UUID$canonical(n.eE),
									n,
									acc);
							}),
						elm$core$Dict$empty,
			...
			case 13:
				...
				var newConfig = _Utils_update(
					config,
					{
						hf: A2(elm$core$Set$member, fId, config.hf) ? A2(elm$core$Set$remove, fId, config.hf) : A2(elm$core$Set$insert, fId, config.hf)
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 14:
				...
				var newConfig = _Utils_update(
					config,
					{
						hg: A2(elm$core$Set$member, nId, config.hg) ? A2(elm$core$Set$remove, nId, config.hg) : A2(elm$core$Set$insert, nId, config.hg)
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 18:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bg: A2(author$project$Gallery$HeaderGallery$update, hgMsg, model.bg)
						}),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		bb: (window.eJ <= 600) ? 0 : (((window.eJ > 600) && (window.eJ <= 1200)) ? 1 : (((window.eJ > 1200) && (window.eJ <= 1800)) ? 2 : 3)),
		cs: (_Utils_cmp(window.eJ, window.dI) < 0) ? 0 : 1
	};
};
...
var author$project$Gallery$HeaderGallery$decodeKeyboard = A2(elm$json$Json$Decode$field, 'keyCode', elm$json$Json$Decode$int);
...
var author$project$Gallery$HeaderGallery$Next = {$: 0};
var author$project$Gallery$HeaderGallery$Previous = {$: 1};
var author$project$Gallery$HeaderGallery$keycodeToMsg = function (keyCode) {
	switch (keyCode) {
		case 37:
			return elm$json$Json$Decode$succeed(author$project$Gallery$HeaderGallery$Previous);
		case 39:
			return elm$json$Json$Decode$succeed(author$project$Gallery$HeaderGallery$Next);
		default:
...
var author$project$Gallery$HeaderGallery$DragEnd = {$: 5};
		...
		_Utils_ap(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Events$on,
					'keydown',
					A2(elm$json$Json$Decode$andThen, author$project$Gallery$HeaderGallery$keycodeToMsg, author$project$Gallery$HeaderGallery$decodeKeyboard))
				])));
};
...
var author$project$Gallery$HeaderGallery$moveChunk = function (model) {
	var animOffset = function () {
		var _n2 = model.U;
		if (_n2.$ === 1) {
			return 0;
		} else {
			var _n3 = _n2.a;
			var anim = _n3.a;
			return A2(mgold$elm_animation$Animation$animate, model.bu, anim);
		}
	}();
	var _n0 = model.A;
	if (_n0.$ === 1) {
		return mdgriffith$elm_ui$Element$moveLeft(1000 + animOffset);
	} else {
		var _n1 = _n0.a;
		var start = _n1.a;
		var stop = _n1.b;
		return ((start.ab - stop.ab) <= 0) ? mdgriffith$elm_ui$Element$moveRight(
			(-1000) + elm$core$Basics$abs(start.ab - stop.ab)) : mdgriffith$elm_ui$Element$moveLeft((1000 + start.ab) - stop.ab);
	}
};
...
var mdgriffith$elm_ui$Internal$Style$classes = {eM: 'a', cB: 'atv', eT: 'ab', eU: 'cx', eV: 'cy', eW: 'acb', eX: 'accx', eY: 'accy', eZ: 'acr', di: 'al', dj: 'ar', e_: 'at', cC: 'ah', cD: 'av', e1: 's', e6: 'bh', e7: 'b', fa: 'w7', fc: 'bd', fd: 'bdt', bW: 'bn', fe: 'bs', bY: 'cpe', fp: 'cp', fq: 'cpx', fr: 'cpy', aD: 'c', b_: 'ctr', b$: 'cb', b0: 'ccx', aE: 'ccy', bw: 'cl', b1: 'cr', fB: 'ct', fG: 'cptr', fH: 'ctxt', f6: 'fcs', f9: 'fs', gf: 'g', cY: 'hbh', ca: 'hc', cZ: 'hf', dK: 'hfp', gm: 'hv', gr: 'ic', gx: 'fr', gz: 'iml', gA: 'it', gD: 'i', bk: 'nb', d1: 'notxt', g8: 'ol', g9: 'or', a1: 'oq', hj: 'oh', d6: 'pg', d7: 'p', hn: 'ppe', s: 'ui', em: 'r', hI: 'sb', hJ: 'sbx', hK: 'sby', hL: 'sbt', h0: 'e', h2: 'cap', h3: 'sev', ic: 'sk', bN: 't', io: 'tc', iq: 'w8', ir: 'w2', is: 'w9', it: 'tj', cz: 'tja', iu: 'tl', iv: 'w3', iw: 'w5', ix: 'w4', iy: 'tr', iz: 'w6', iB: 'w1', iC: 'tun', eD: 'ts', a6: 'clr', iI: 'u', dc: 'wc', eK: 'we', dd: 'wf', eL: 'wfp', de: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.aD);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.gf);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d6);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d7);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.em);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.h0);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.fu)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.h4.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.h4.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.em) + ('-' + (elm$core$String$fromInt(pos.dr) + ('-' + (elm$core$String$fromInt(pos.eJ) + ('-' + elm$core$String$fromInt(pos.dI)))))));
		case 11:
...
var mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.dP ? elm$core$Maybe$Just('inset') : elm$core$Maybe$Nothing,
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.g6.a) + 'px'),
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.g6.b) + 'px'),
					elm$core$Maybe$Just(
...
var mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return A2(
		...
		mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + (':focus .focusable, ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + '.focusable:focus')),
		A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
			_List_fromArray(
							...
							mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
								{
									...
									g6: A2(
										...
										A2(elm$core$Tuple$mapFirst, elm$core$Basics$toFloat, shadow.g6)),
									es: shadow.es
								}));
					},
					focus.h$),
...
var mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		A2(
		mdgriffith$elm_ui$Internal$Style$Class,
		mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.gm, mdgriffith$elm_ui$Internal$Style$classes.a6)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.gm, mdgriffith$elm_ui$Internal$Style$classes.a1)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.f6, mdgriffith$elm_ui$Internal$Style$classes.a6)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.f6, mdgriffith$elm_ui$Internal$Style$classes.a1)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.a6)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.a1)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1 + ':first-child'),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(
							mdgriffith$elm_ui$Internal$Style$classes.e1 + (mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + mdgriffith$elm_ui$Internal$Style$classes.e1))),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(
							mdgriffith$elm_ui$Internal$Style$classes.e1 + (mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + mdgriffith$elm_ui$Internal$Style$classes.e1))),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + (mdgriffith$elm_ui$Internal$Style$classes.e1 + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + (mdgriffith$elm_ui$Internal$Style$classes.e1 + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.em) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.em) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.e1) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.b_) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
var mdgriffith$elm_ui$Internal$Style$Intermediate = elm$core$Basics$identity;
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bZ: closing, B: _List_Nil, aO: _List_Nil, aA: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								B: A2(
									elm$core$List$cons,
									{bZ: '\n}', B: _List_Nil, aO: props, aA: '@supports (' + (prop + (':' + (value + (') {' + parent.aA))))},
									rendered.B)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.aA + ('{' + (renderValues(rule.aO) + (rule.bZ + '}')));
		}
	};
	...
	function (name, modifier, _n0) {
		...
		return _List_fromArray(
			[
				...
				A2(mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.bN + (', .' + (name + (' .' + (modifier + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.bN)))))))))), textAdjustment)
			]);
	});
var mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _n0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3(mdgriffith$elm_ui$Internal$Model$fontRule, name, mdgriffith$elm_ui$Internal$Style$classes.h2, capital),
				A3(mdgriffith$elm_ui$Internal$Model$fontRule, name, mdgriffith$elm_ui$Internal$Style$classes.f9, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.h2 + (', ' + ('.' + (name + (' .' + mdgriffith$elm_ui$Internal$Style$classes.h2))))))),
					_List_fromArray(
						[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.h2 + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.bN + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.h2 + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.bN)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {dI: height / size, es: size, eH: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.fg, adjustment.e5, adjustment.fP, adjustment.gO]);
	var lineHeight = 1.5;
	...
	return {
		fg: A3(mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
		dE: A3(mdgriffith$elm_ui$Internal$Model$adjust, fullSize, ascender - descender, fullVertical)
	};
};
					...
					switch (pseudo) {
						...
						case 0:
							...
							return A2(
								...
								'\n',
								_List_fromArray(
									[selector + ('-fs:focus {' + (renderedProps + '\n}')), '.' + (mdgriffith$elm_ui$Internal$Style$classes.e1 + (':focus ~ ' + (selector + ('-fs:not(.focus)  {' + (renderedProps + '\n}'))))), '.' + (mdgriffith$elm_ui$Internal$Style$classes.e1 + (':focus ' + (selector + ('-fs  {' + (renderedProps + '\n}'))))), '.focusable-parent:focus ~ ' + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + (selector + ('-fs {' + (renderedProps + '\n}'))))))]));
						default:
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var single = '.' + mdgriffith$elm_ui$Internal$Style$classes.h0;
						var row = '.' + mdgriffith$elm_ui$Internal$Style$classes.em;
						...
						var page = '.' + mdgriffith$elm_ui$Internal$Style$classes.d6;
						...
						var _class = '.' + cls;
						var any = '.' + mdgriffith$elm_ui$Internal$Style$classes.e1;
						return elm$core$String$concat(
							_List_fromArray(
								[
									A3(
					...
					case 8:
						...
						var xSpacing = toGridLength(template.h4.a);
						var ySpacing = toGridLength(template.h4.b);
						var rows = function (x) {
						...
						var msRows = function (x) {
							...
							A2(
								elm$core$String$join,
								ySpacing,
								A2(elm$core$List$map, toGridLength, template.fu)));
						var msColumns = function (x) {
							...
							A2(
								...
								ySpacing,
								A2(elm$core$List$map, toGridLength, template.fu)));
						var gapY = 'grid-row-gap:' + (toGridLength(template.h4.b) + ';');
						var gapX = 'grid-column-gap:' + (toGridLength(template.h4.a) + ';');
					...
					case 9:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									'-ms-grid-row: ' + (elm$core$String$fromInt(position.em) + ';'),
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.em) + (' / ' + (elm$core$String$fromInt(position.em + position.dI) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.dr) + (' / ' + (elm$core$String$fromInt(position.dr + position.eJ) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.em) + ('-' + (elm$core$String$fromInt(position.dr) + ('-' + (elm$core$String$fromInt(position.eJ) + ('-' + elm$core$String$fromInt(position.dI)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.e1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.h0))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.b_, mdgriffith$elm_ui$Internal$Style$classes.aE, mdgriffith$elm_ui$Internal$Style$classes.eZ])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.b_, mdgriffith$elm_ui$Internal$Style$classes.aE, mdgriffith$elm_ui$Internal$Style$classes.eX])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.b_, mdgriffith$elm_ui$Internal$Style$classes.eY])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.b_, mdgriffith$elm_ui$Internal$Style$classes.eW])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.bN, mdgriffith$elm_ui$Internal$Style$classes.dc, mdgriffith$elm_ui$Internal$Style$classes.ca])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.bN, mdgriffith$elm_ui$Internal$Style$classes.dd, mdgriffith$elm_ui$Internal$Style$classes.cZ])))
			]),
		_List_fromArray(
			[
...
var mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.gn, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.ie : _Utils_ap(styled.ie, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.gn, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.ie : _Utils_ap(styled.ie, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _n1.a;
			var styles = _n1.b;
			var newStyles = elm$core$List$isEmpty(styles) ? rendered.ie : _Utils_ap(rendered.ie, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.eM]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.e7]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.g9]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.g8]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.gx]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.bk, mdgriffith$elm_ui$Internal$Style$classes.h0, mdgriffith$elm_ui$Internal$Style$classes.e6]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.gn, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + mdgriffith$elm_ui$Internal$Style$classes.di);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dj);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eU);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.cD + (' ' + mdgriffith$elm_ui$Internal$Style$classes.e_);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.cD + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eT);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.cD + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eV);
	}
};
	...
	switch (h.$) {
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				A2(mdgriffith$elm_ui$Internal$Flag$add, mdgriffith$elm_ui$Internal$Flag$heightFill, mdgriffith$elm_ui$Internal$Flag$none),
				mdgriffith$elm_ui$Internal$Style$classes.dK + (' height-fill-' + elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
						mdgriffith$elm_ui$Internal$Style$classes.e1 + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.em + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
							...
							switch (height.$) {
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.dK + (' height-fill-' + elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$elm_ui$Internal$Flag$add,
											mdgriffith$elm_ui$Internal$Flag$heightFill,
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.e1 + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.aD + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.ie);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$px(config.cg)),
						mdgriffith$elm_ui$Element$height(
						mdgriffith$elm_ui$Element$px(
							elm$core$Basics$round(config.cg / 5))),
						A2(elm$core$Set$member, src, model.dX) ? mdgriffith$elm_ui$Element$Background$image(src) : mdgriffith$elm_ui$Element$Background$uncropped('/assets/images/loading.gif')
					]),
		...
		case 1:
			...
			return styled.gn(
				A2(
					...
					{
						f6: {e4: elm$core$Maybe$Nothing, fb: elm$core$Maybe$Nothing, h$: elm$core$Maybe$Nothing},
						gm: 1,
						c: 1
					},
					styled.ie));
			...
			return A2(
				...
				function (mc) {
					return A2(
						...
						_Utils_ap(
							author$project$Gallery$HeaderGallery$events(model.A),
							_List_fromArray(
								[mc])),
						_List_fromArray(
							[
				...
				author$project$Gallery$HeaderGallery$moveChunk(model));
		} else {
...
var mdgriffith$elm_ui$Element$clipX = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.fq);
	...
	function (model, config) {
		return A2(
			...
			A3(
				...
				model,
				config,
				author$project$Internals$Streams$current(model.p)));
	});
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.fB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bw)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.aE)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.bw + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.de)))),
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
						A2(
								...
								A2(
									...
									elm$core$List$reverse(
										A2(
											elm$core$String$split,
											'/',
											A2(elm$core$String$dropLeft, 1, model.db.z))))))))
				]));
	});
var mdgriffith$elm_ui$Internal$Model$Top = 0;
var mdgriffith$elm_ui$Element$alignTop = mdgriffith$elm_ui$Internal$Model$AlignY(0);
var mdgriffith$elm_ui$Element$spaceEvenly = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$spacing, mdgriffith$elm_ui$Internal$Style$classes.h3);
			...
			return A2(
				...
				_List_Nil,
				{
					f: A2(
						mdgriffith$elm_ui$Element$el,
						_List_Nil,
						mdgriffith$elm_ui$Element$text(pageInfo.x)),
					db: strPath(pageInfo.z)
				});
		};
		var maxWidth = A3(
			author$project$Document$DocumentViews$StyleSheets$docMaxWidth,
			_Utils_Tuple2(model.b.eJ, model.b.dI),
			false,
			model.b.hu);
...
var author$project$Document$DocumentViews$DocumentResponsive$flipTable = function (_n0) {
	...
	return {fK: newData, g$: nbrRows, g0: nbrCols, id: style};
};
	...
	function (config, document) {
		...
		if (!document.$) {
			...
			switch (cellContent.$) {
				...
				case 2:
					var meta = cellContent.a;
					return (((!device.bb) || (device.bb === 1)) && (_Utils_cmp(meta.g$, meta.g0) > 0)) ? author$project$Document$Document$Cell(
						{
							h: attrs,
		...
		return _Utils_ap(
			A2(
				...
				A2(
					...
					function (id) {
						return A2(elm$core$Dict$get, id, customStyles.go);
					},
					docStyleId)),
			_Utils_ap(
				A2(
...
var mdgriffith$elm_ui$Element$Border$solid = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$borderStyle, mdgriffith$elm_ui$Internal$Style$classes.fe);
...
var mdgriffith$elm_ui$Element$Font$alignLeft = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.iu);
var mdgriffith$elm_ui$Element$Font$alignRight = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.iy);
var mdgriffith$elm_ui$Element$Font$center = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.io);
var mdgriffith$elm_ui$Element$Font$italic = mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.gD);
var mdgriffith$elm_ui$Element$Font$justify = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.it);
							...
							case 4:
								return _List_fromArray(
									[
										...
										mdgriffith$elm_ui$Element$htmlAttribute(
										A2(elm$html$Html$Attributes$style, 'transition', '0.3s')),
										mdgriffith$elm_ui$Element$Events$onDoubleClick(handlers.fk)
									]);
							default:
								return _List_fromArray(
									[
...
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ba: charsProcessed, bf: hash, hN: seed, bp: shift};
	});
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data.bf ? (data.hN ^ A2(
		Skinney$murmur3$Murmur3$multiplyBy,
		Skinney$murmur3$Murmur3$c2,
		A2(
			Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2(Skinney$murmur3$Murmur3$multiplyBy, Skinney$murmur3$Murmur3$c1, data.bf)))) : data.hN;
	var h0 = acc ^ data.ba;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.bf | ((255 & elm$core$Char$toCode(c)) << data.bp);
		var _n0 = data.bp;
		if (_n0 === 24) {
			return {
				ba: data.ba + 1,
				bf: 0,
				hN: A2(Skinney$murmur3$Murmur3$mix, data.hN, res),
				bp: 0
			};
		} else {
			return {ba: data.ba + 1, bf: res, hN: data.hN, bp: data.bp + 8};
		}
	});
...
var mdgriffith$elm_ui$Internal$Model$boxShadowName = function (shadow) {
	return elm$core$String$concat(
		_List_fromArray(
			[
				shadow.dP ? 'box-inset' : 'box-',
				elm$core$String$fromFloat(shadow.g6.a) + 'px',
				elm$core$String$fromFloat(shadow.g6.b) + 'px',
				elm$core$String$fromFloat(shadow.e9) + 'px',
				elm$core$String$fromFloat(shadow.es) + 'px',
				mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.fs)
			]));
};
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {e9: almostShade.e9, fs: almostShade.fs, dP: false, g6: almostShade.g6, es: almostShade.es};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
					...
					[
						...
						_List_fromArray(
							[
								...
								{
									e9: 10,
									fs: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.45),
									g6: _Utils_Tuple2(4, 4),
									es: 5
								})
							]))
					])),
						...
						_List_fromArray(
							[
								...
								A2(
									...
									A3(
										author$project$Document$DocumentViews$StyleSheets$docMaxWidth,
										_Utils_Tuple2(config.eJ, config.dI),
										config.fV,
										config.hu),
...
var author$project$Document$DocumentViews$DocumentView$renderBlocksLinksMeta = F5(
	function (nbrChunks, config, id, attrs, _n0) {
		var image = _n0.gq;
		var label = _n0.f;
		var targetBlank = _n0.ex;
		var url = _n0.db;
		var url_ = targetBlank ? url : A2(
			elm$core$Maybe$withDefault,
			'',
			A2(elm$core$Dict$get, url, config.hk));
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							(!config.fV) ? mdgriffith$elm_ui$Element$mouseOver(
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
		...
		switch (tbe.$) {
			...
			case 2:
				...
				var headingStyle = A2(
					elm$core$Maybe$withDefault,
					_List_Nil,
					A2(elm$core$Dict$get, level, styleSheet.gi));
				return A2(
					mdgriffith$elm_ui$Element$paragraph,
					_Utils_ap(
						_List_fromArray(
	...
	function (config, id, attrs, s) {
		return _List_fromArray(
			[
				...
				elm$core$Maybe$withDefault,
				mdgriffith$elm_ui$Element$none,
				A2(elm$core$Dict$get, s, config.fI))
			]);
	});
									...
									f: A2(
										...
										_List_fromArray(
											[
												...
												mdgriffith$elm_ui$Element$Background$image('/images/visiteVirt.jpg'),
												mdgriffith$elm_ui$Element$Border$width(5),
												mdgriffith$elm_ui$Element$Border$color(
												A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1))
											]),
										mdgriffith$elm_ui$Element$none),
									db: 'visite/visite-virtuelle-aerienne-murol.html'
								}),
								A2(
								mdgriffith$elm_ui$Element$row,
								_List_fromArray(
...
var author$project$GeneralDirectoryEditor$FichePreview$descriptionView = function (_n0) {
	var description = _n0.fS;
	var ouverture = _n0.hi;
	var _n1 = function () {
					...
					[
						...
						_List_fromArray(
							[
								...
								{
									e9: 1,
									fs: A3(mdgriffith$elm_ui$Element$rgb255, 25, 21, 0),
									g6: _Utils_Tuple2(1, 0)
								})
							]),
						mdgriffith$elm_ui$Element$text(
...
var mdgriffith$elm_ui$Element$clip = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.fp);
var author$project$GeneralDirectoryEditor$FichePreview$refView = F2(
	function (maxWidth, _n0) {
		...
		var toImage = function (_n8) {
			var lien = _n8.gJ;
			var logo = _n8.gN;
			return {dI: logo.dI, bB: lien, db: logo.db, eJ: logo.eJ};
		};
		...
		var _n1 = function () {
			...
			if (!_n2.$) {
				...
				return _Utils_Tuple2(
					_List_fromArray(
						[
							{dI: 50, bB: 'https://etoiles-de-france.fr/', db: 'stars', eJ: 80}
						]),
					n);
			} else {
		...
		var imgsScaledToMinHeight = function () {
			var scale = function (_n5) {
				...
				var height = _n5.dI;
				var link = _n5.bB;
				return {dI: minHeight + 5, bB: link, db: url, eJ: (minHeight * width) / height};
			};
...
var author$project$Document$DocumentViews$DocumentView$renderFiches = F4(
	function (config, id, attrs, fichesId) {
		...
		var fiches = A2(
			elm$core$List$filterMap,
			function (fId) {
				return A2(elm$core$Dict$get, fId, config.f3);
			},
			fichesId);
		var containerWidth = author$project$Document$DocumentViews$StyleSheets$getContainerWidth(config);
		var maxWidth = function () {
	...
	function (config, id, attrs, _n0) {
		...
		var attrs_ = _Utils_ap(
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(
					A2(mdgriffith$elm_ui$Element$maximum, size.gv, mdgriffith$elm_ui$Element$fill))
				]),
			_Utils_ap(
				styleSheet.gs,
				_Utils_ap(
...
var elm$time$Time$toYear = F2(
	function (zone, time) {
		return elm$time$Time$toCivil(
			A2(elm$time$Time$toAdjustedMinutes, zone, time)).iS;
	});
...
var AdrianRibao$elm_derberos_date$Derberos$Date$Core$newDateRecord = F8(
	function (year, month, day, hour, minute, second, millis, zone) {
		return {fM: day, cb: hour, cl: millis, cm: minute, gX: month, cy: second, iS: year, df: zone};
	});
...
var AdrianRibao$elm_derberos_date$Derberos$Date$Core$civilToPosixUnadjusted = function (dateRecord) {
	var y = dateRecord.iS - ((dateRecord.gX <= 2) ? 1 : 0);
	var time = ((((dateRecord.cb * 3600) * 1000) + ((dateRecord.cm * 60) * 1000)) + (dateRecord.cy * 1000)) + dateRecord.cl;
	var mp = A2(elm$core$Basics$modBy, 12, dateRecord.gX + 9);
	var era = elm$core$Basics$floor(y / 400);
	var yoe = y - (era * 400);
	var doy = (((((153 * mp) + 2) / 5) | 0) + dateRecord.fM) - 1;
...
var author$project$Internals$CommonHelpers$dateToStr = F2(
	function (zone, d) {
		...
		return A3(
			...
			2,
			'0',
			elm$core$String$fromInt(dateRec.fM)) + ('/' + (A3(
			elm$core$String$padLeft,
			2,
			'0',
			elm$core$String$fromInt(dateRec.gX)) + ('/' + elm$core$String$fromInt(dateRec.iS))));
	});
...
var mdgriffith$elm_ui$Element$Border$roundEach = function (_n0) {
	var topLeft = _n0.ez;
	var topRight = _n0.eA;
	var bottomLeft = _n0.dm;
	var bottomRight = _n0.dn;
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
		mdgriffith$elm_ui$Internal$Flag$borderRound,
		A3(
	...
	function (config, id, attrs) {
		...
		var sortedNews = elm$core$List$reverse(
			A2(
				...
				elm$core$Dict$values(config.g2)));
		var lastUpdate = A2(
			elm$core$Maybe$map,
		...
		var renderNewsBody = F3(
			function (uuid, pic, content) {
				...
				if (A2(
					...
					TSFoster$elm_uuid$UUID$canonical(uuid),
					config.hg)) {
					var _n3 = _Utils_Tuple2(pic, device.bb);
					if (!_n3.a.$) {
						if (!_n3.b) {
							var url = _n3.a.a.db;
							var _n4 = _n3.b;
							return _List_fromArray(
								[
									...
									_Utils_ap(
										...
										A4(author$project$Document$DocumentViews$DocumentView$renderTextBlock, config, id, content.h, content.il)))
								]);
						} else {
							var url = _n3.a.a.db;
							return _List_fromArray(
			...
			function (uuid, title, date) {
				...
				var headerAttr = _List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$Border$widthEach(
						{ac: 1, ae: 0, ak: 0, al: 0}),
						mdgriffith$elm_ui$Element$Border$color(author$project$Internals$CommonStyleHelpers$grey5),
				...
				var chevronsView = A2(
					...
					mdgriffith$elm_ui$Element$html(
						A2(
							elm$core$Set$member,
							TSFoster$elm_uuid$UUID$canonical(uuid),
							config.hg) ? author$project$Internals$Icons$chevronsUp(18) : author$project$Internals$Icons$chevronsDown(18)));
				var _n2 = device.bb;
				if (!_n2) {
					return A2(
						mdgriffith$elm_ui$Element$column,
							...
							[
								...
								_List_fromArray(
									[
										...
										dateAttr,
										mdgriffith$elm_ui$Element$text(
											A2(author$project$Internals$CommonHelpers$dateToStr, config.df, date))),
										chevronsView
									]))
							]));
				} else {
								...
								function (lastUp) {
									return A2(
										...
										_List_fromArray(
											[
												mdgriffith$elm_ui$Element$text(
												'Dernière mise à jour le ' + A2(author$project$Internals$CommonHelpers$dateToFrench, config.df, lastUp))
											]));
								},
								lastUpdate))
						]),
					...
					picLink,
					{
						gt: _Utils_update(
							img,
							{
								es: {
									gu: minHeight + 5,
									gv: elm$core$Basics$round((minHeight * img.es.gv) / img.es.gu)
								}
							})
					});
			};
			...
			return config.fV ? A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$width(
						mdgriffith$elm_ui$Element$fillPortion(
							elm$core$Basics$floor((10000 * img.es.gv) / totalImgWidth)))
					]),
				mdgriffith$elm_ui$Element$html(
					A2(
						elm$html$Html$img,
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$Border$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 255, 200, 50)),
						mdgriffith$elm_ui$Element$Border$rounded(2),
						mdgriffith$elm_ui$Element$mouseOver(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Border$color(
								A3(mdgriffith$elm_ui$Element$rgb255, 89, 58, 46))
							]))
					]),
				{
...
var mdgriffith$elm_ui$Element$tableHelper = F2(
	function (attrs, config) {
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Internal$Model$GridPosition(
								{dr: columnLevel, dI: 1, em: rowLevel, eJ: 1}))
						]),
					mdgriffith$elm_ui$Internal$Model$Unkeyed(
						_List_fromArray(
							[elem])));
		...
		var maybeHeaders = function (headers) {
			...
			A2(elm$core$List$map, columnHeader, config.fu));
		var add = F3(
						...
						cursor,
						{
							...
							at: A2(
								...
								A3(
									...
									A2(
										col.iM,
										_Utils_eq(maybeHeaders, elm$core$Maybe$Nothing) ? (cursor.em - 1) : (cursor.em - 2),
										cell)),
								cursor.at)
						});
				} else {
		...
		var build = F3(
			function (columns, rowData, cursor) {
				var newCursor = A3(
					...
					cursor,
					columns);
				return {aD: 1, at: newCursor.at, em: cursor.em + 1};
			});
		var children = A3(
			elm$core$List$foldl,
			build(config.fu),
			{
				aD: 1,
				at: _List_Nil,
				em: _Utils_eq(maybeHeaders, elm$core$Maybe$Nothing) ? 1 : 2
			},
			config.fK);
		var _n0 = A2(
		...
		var template = A2(
			...
			mdgriffith$elm_ui$Internal$Model$GridTemplateStyle(
				{
					fu: A2(elm$core$List$map, columnWidth, config.fu),
					hG: A2(
						elm$core$List$repeat,
						elm$core$List$length(config.fK),
...
var mdgriffith$elm_ui$Element$indexedTable = F2(
	function (attrs, config) {
		return A2(
			...
			attrs,
			{
				fu: A2(elm$core$List$map, mdgriffith$elm_ui$Element$InternalIndexedColumn, config.fu),
				fK: config.fK
			});
	});
var mdgriffith$elm_ui$Element$scrollbarX = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.hJ);
var author$project$Document$DocumentViews$DocumentView$renderTable = F4(
	function (config, id, attrs, _n0) {
		...
		var columns = A2(
			...
			function (ci) {
				return {
					gg: mdgriffith$elm_ui$Element$none,
					iM: F2(
						function (ri, row) {
							return A2(
								mdgriffith$elm_ui$Element$el,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							videoMeta.h7),
							(!videoMeta.f8) ? elm$core$Maybe$Just('frameborder=0') : elm$core$Maybe$Nothing,
							(!videoMeta.ih) ? elm$core$Maybe$Just('rel=0') : elm$core$Maybe$Nothing,
							(!videoMeta.fD) ? elm$core$Maybe$Just('controls=0') : elm$core$Maybe$Nothing,
							(!videoMeta.da) ? elm$core$Maybe$Just('showinfo=0') : elm$core$Maybe$Nothing
						]))));
		return 'https://www.youtube' + ((videoMeta.hv ? '-nocookie' : '') + ('.com/embed/' + (src + params)));
	});
					...
					A2(
						...
						_List_fromArray(
							[
								...
								A2(author$project$PageEditor$Internals$DocumentEditorHelpers$buildYoutubeUrl, vidMeta.eu, vidMeta)),
								elm$html$Html$Attributes$width(vidMeta.es.iL),
								elm$html$Html$Attributes$height(vidMeta.es.iK),
								vidMeta.f8 ? author$project$Internals$CommonStyleHelpers$noHtmlAttr : A2(elm$html$Html$Attributes$attribute, 'frameborder', '0'),
						...
						_Utils_ap(
							...
							_Utils_ap(
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$width(
										A2(mdgriffith$elm_ui$Element$maximum, config.eJ, mdgriffith$elm_ui$Element$fill)),
										mdgriffith$elm_ui$Element$alignTop
									]),
								A2(author$project$Document$DocumentViews$DocumentView$renderAttrs, config, attrs))))),
				A2(
...
var author$project$Murol$mainView = F2(
	function (maxWidth, model) {
		...
		var _n0 = A2(elm$core$Dict$get, model.db.z, model.ah);
		_n0$2:
		while (true) {
			if (!_n0.$) {
				switch (_n0.a.c.$) {
					case 2:
						...
						return A2(
							...
							A2(
								...
								model.b,
								A2(author$project$Document$DocumentViews$DocumentResponsive$responsivePreFormat, model.b, doc)));
					case 1:
						var _n2 = _n0.a;
						var cId = _n2.a;
						var name = _n2.b;
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.hL + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d1)))))),
						A2(
							elm$core$List$cons,
							mdgriffith$elm_ui$Element$pointer,
							A2(
			...
			if (!_n1.$) {
				...
				return _Utils_Tuple3(
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Input$value(textOptions.bN),
								mdgriffith$elm_ui$Internal$Model$Attr(
								elm$html$Html$Attributes$type_(inputType)),
								mdgriffith$elm_ui$Element$Input$spellcheck(textInput._),
				...
				var _n3 = A3(
					...
					{H: _List_Nil, ca: elm$core$Maybe$Nothing, ch: elm$core$Maybe$Nothing, ci: elm$core$Maybe$Nothing, cj: elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _n3.ci;
				var heightContent = _n3.ca;
				var maybeSpacing = _n3.cj;
				var adjustedAttributes = _n3.H;
				var maybeBorder = _n3.ch;
				...
				return _Utils_Tuple3(
						...
						_List_fromArray(
							[
								...
								if (heightContent.$ === 1) {
									...
									if (heightContent.a) {
										return A4(mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.bN, spacing, maybePadding, maybeBorder);
									} else {
										return mdgriffith$elm_ui$Internal$Model$NoAttribute;
									}
								}
					...
					_List_fromArray(
						[
							...
							elm$html$Html$text(textOptions.bN))
						]));
			}
		}();
		var inputNode = _n0.a;
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.d1 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.hn)),
																mdgriffith$elm_ui$Element$Border$color(
...
var author$project$Murol$searchEngineView = F2(
	function (maxWidth, model) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A4(author$project$Document$DocumentViews$DocumentView$customHeading, model.b, 1, _List_Nil, 'RECHERCHER SUR LE SITE'),
					A2(
					mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									...
									(model.b.eJ < 500) ? mdgriffith$elm_ui$Element$width(
								...
								]),
							{
								...
								bE: author$project$Murol$SearchPromptInput,
							...
							author$project$Internals$CommonStyleHelpers$buttonStyle((model.bo !== '') && (model.a5 !== 1)),
							{
								f: A2(
									mdgriffith$elm_ui$Element$el,
									_List_Nil,
		...
		var subCatView = function (_n3) {
			...
			return A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Background$color(
						A4(mdgriffith$elm_ui$Element$rgba255, 229, 189, 33, 1)),
						mdgriffith$elm_ui$Element$mouseOver(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Background$color(
								A3(mdgriffith$elm_ui$Element$rgb255, 255, 237, 167))
							])),
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
					]),
				A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						author$project$Murol$UnfoldTopic(pageInfo.x)),
						mdgriffith$elm_ui$Element$Events$onMouseLeave(author$project$Murol$FoldTopic),
						_Utils_eq(
						model.bS,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(mdgriffith$elm_ui$Element$maximum, maxWidth, mdgriffith$elm_ui$Element$fill)),
					mdgriffith$elm_ui$Element$Background$color(
					A4(mdgriffith$elm_ui$Element$rgba255, 255, 211, 37, 1))
				]),
			_List_fromArray(
				[
					A2(
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_n4.$ === 1) {
						return _Utils_update(
							record,
							{
								gm: elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{f6: elm$core$Maybe$Nothing, gm: elm$core$Maybe$Nothing, c: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.s, mdgriffith$elm_ui$Internal$Style$classes.e1, mdgriffith$elm_ui$Internal$Style$classes.h0]))),
...
var author$project$Murol$view = function (model) {
	return {
					...
					A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
								mdgriffith$elm_ui$Element$height(
								mdgriffith$elm_ui$Element$px(model.b.dI)),
								mdgriffith$elm_ui$Element$clip,
								mdgriffith$elm_ui$Element$Background$image(
								author$project$Document$DocumentViews$StyleSheets$backgroundImage(model.b.hM))
							]),
						A2(
							mdgriffith$elm_ui$Element$column,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									device.bb ? author$project$Murol$topMenuView(model) : mdgriffith$elm_ui$Element$none,
		...
		da: 'La commune de Murol'
	};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Murol$main = elm$browser$Browser$application(
	{gy: author$project$Murol$init, ha: author$project$Murol$ChangeUrl, hb: author$project$Murol$ClickedLink, ig: author$project$Murol$subscriptions, iJ: author$project$Murol$update, iM: author$project$Murol$view});
					...
					return A2(
						...
						function (currentTime) {
							return elm$json$Json$Decode$succeed(
								{fF: currentTime, dI: height, eJ: width});
						},
