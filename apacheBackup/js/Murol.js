...
var author$project$Murol$init = F3(
	function (flags, url, key) {
		...
		return _Utils_Tuple2(
			{config: config, key: key, pageTree: elm$core$Maybe$Nothing, pages: elm$core$Dict$empty, url: url_},
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
